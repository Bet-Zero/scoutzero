...
| Zero/one-YOS uplift is missing from Tax Salary | Exercise an exact 2026-27 zero-YOS one-year Minimum Standard Contract, a one-YOS control, and veteran/non-Minimum controls while the seeded C08.7 line remains zero | C07.3 Apron and C08.7 Tax each receive one operation-specific exact uplift; C08.2 remains separate, Team Salary is unchanged by the uplift, and persistence/reload cannot omit or duplicate it |
