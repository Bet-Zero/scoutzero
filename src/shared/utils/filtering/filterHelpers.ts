...
export function getFilterDisplayValue(
  ...
  if (typeof value === 'object' && value !== null) {
    ...
    if (key === 'subRoles') {
      return [
        ...((obj.offense as string[]) || []),
        ...((obj.defense as string[]) || []),
      ].join(', ');
    }
  }
...
export function getFilterStyles(key: string, value: unknown): FilterStyles {
  const defaultStyles: FilterStyles = {
    bgClass: 'bg-[#2a2a2a]',
