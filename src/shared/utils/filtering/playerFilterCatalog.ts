...
export const PLAYER_FILTER_CATALOG: FilterCatalogEntry[] = [
  // ===== BASIC FILTERS =====
  {
    ...
    label: 'Name Search',
    type: 'string',
    uiSources: ['PlayerTableHeader/index.jsx'],
    predicateFile: 'src/shared/utils/filtering/playerFilterUtils.js',
  ...
  },
  {
    ...
    label: 'Team',
    type: 'string',
    uiSources: ['TopControlsBar.jsx', 'MetadataFilters.jsx'],
    predicateFile: 'src/shared/utils/filtering/playerFilterUtils.js',
  ...
  },
  {
    ...
    label: 'Salary Year',
    type: 'number',
    uiSources: ['TopControlsBar.jsx', 'ContractFilters.jsx'],
    predicateFile: 'src/shared/utils/filtering/playerFilterUtils.js',
  ...
  // ===== EVALUATION FILTERS =====
  {
    ...
    type: 'number',
    uiSources: ['OverallGradeFilter.jsx'],
    predicateFile: 'src/shared/utils/filtering/playerFilterUtils.js',
  ...
  },
  {
    ...
    label: 'Offense Role',
    type: 'string',
    uiSources: ['TopControlsBar.jsx', 'RoleFilters.jsx'],
    predicateFile: 'src/shared/utils/filtering/playerFilterUtils.js',
