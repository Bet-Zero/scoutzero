 ...
 */
export function normalizeSeason(season: SeasonInputLike): string | null {
 ...
 */
export function seasonStartYear(season: SeasonInputLike): number {
  if (!season) return 0;
...
export function compareSeason(
  season1: SeasonInputLike,
  season2: SeasonInputLike
): number {
...
export function isSeasonActive(
  startSeason: SeasonInputLike,
  endSeason: SeasonInputLike,
 ...
 */
export function isSeasonFuture(
  startSeason: SeasonInputLike,
  currentSeason: SeasonInputLike
): boolean {
