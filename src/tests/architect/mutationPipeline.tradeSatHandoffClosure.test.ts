...
describe('mutationPipeline trade/SAT handoff closure', () => {
    ...
    const result = requireSuccessfulMutationResult(computeWorldMutation({
      ...
      payload: {
        teams: [
          {
            teamCode: 'TMA',
            sends: [{ player_id: 'player_a', name: 'Player A' }],
            entitlementsOut: [],
          },
          {
            teamCode: 'TMB',
            sends: [{ player_id: 'player_b', name: 'Player B' }],
            entitlementsOut: [],
          },
        ],
  ...
  it('preserves three-team routing through the canonical tradeTo handoff field', () => {
    ...
    const result = requireSuccessfulMutationResult(computeWorldMutation({
      ...
      payload: {
        teams: [
          {
            teamCode: 'TMA',
            sends: [{ player_id: 'a_out', name: 'A Out', tradeTo: 'TMB' }],
            entitlementsOut: [],
          },
          {
            teamCode: 'TMB',
            sends: [{ player_id: 'b_out', name: 'B Out', tradeTo: 'TMC' }],
            entitlementsOut: [],
          },
          {
            teamCode: 'TMC',
            sends: [{ player_id: 'c_out', name: 'C Out', tradeTo: 'TMA' }],
            entitlementsOut: [],
          },
        ],
        capProjections: makeCapProjections(),
