...
vi.mock('@/features/architect/GMDashboard/hooks/useArchitectActions', () => ({
  useArchitectActions: () => ({
    ...
    handleInjectCapSheetFixtures: vi.fn(),
    handleClearCapSheetFixtures: vi.fn(),
    ...
    handleSaveContract: vi.fn(async () => ({ success: true })),
    ...
    handleInjectTeamHistoryFixtures: vi.fn(),
    handleClearTeamHistoryFixtures: vi.fn(),
