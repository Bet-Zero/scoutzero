 ...
 *
 * @file src/utils/architect/schemaAdapter.js
 ...
 */
export function buildTradeTeamInput(teamState, tradeData = {}) {
  if (!teamState) {
    return null;
  }
 ...
 */
export function adaptPlayerForValidator(playerData, _currentYear = null) {
 ...
 */
export function adaptContractForValidator(contract, _currentYear = null) {
  void _currentYear; // Unused parameter kept for API compatibility
  if (!contract) {
    return null;
  }
 ...
 */
export function buildTradeInput(tradeInput, _currentYear = null) {
  void _currentYear; // Unused parameter kept for API compatibility
