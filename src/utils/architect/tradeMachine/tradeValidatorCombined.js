...
function validateTradeExceptions(team) {
  const violations = [];
...
function validateDraftPicks(team, allTeams) {
  const violations = [];
...
function validateRosterLimits(team) {
  const violations = [];
...
function validateSignAndTrade(team) {
  const violations = [];
...
function validateSecondApronAggregation(team) {
  const violations = [];
...
function validateAllNewRules(team, allTeams) {
  return [
