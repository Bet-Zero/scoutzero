...
const RoleFilters = ({ filters, setFilters }) => {
  ...
  return (
    <div className="bg-[#1a1a1a] p-4 rounded-md border border-white/10">
      ...
      <div className="grid grid-cols-3 gap-4 text-white text-sm mb-4">
        ...
        <div className="flex flex-col">
          ...
          <select
            ...
            onChange={(e) => update('offenseRole', e.target.value)}
        ...
        <div className="flex flex-col">
          ...
          <select
            ...
            onChange={(e) => update('defenseRole', e.target.value)}
            className="bg-[#2a2a2a] p-2 rounded text-sm border border-white/10"
          >
            <option value="">All Roles</option>
        ...
        <div className="flex flex-col">
          ...
          <select
            ...
            onChange={(e) => update('shootingProfile', e.target.value)}
            className="bg-[#2a2a2a] p-2 rounded text-sm border border-white/10"
          >
      ...
      {(filters.subRoles?.offense?.length > 0 ||
        ...
        <div className="mb-3">
          ...
          <div className="flex flex-wrap gap-1">
            {[
              ...(filters.subRoles?.offense || []),
              ...(filters.subRoles?.defense || []),
            ].map((role) => {
              const roleData = SubRoleMasterList.find((r) => r.name === role);
      ...
      {/* Subroles Section */}
      <div className="mt-4" ref={subroleMenuRef}>
        <button
