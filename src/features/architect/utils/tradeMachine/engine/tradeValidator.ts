...
function normalizeTeamCodeLike(teamIdLike: unknown): string | null {
...
function resolvePlayerDestinationTeamId(
...
function normalizeTradeValidationDate(
...
function getDeterministicValidationDate(currentYear: number): string {
  return `${currentYear - 1}-07-15`;
}

function deriveSeasonStateFromDate(asOfDate: string | number | Date | null | undefined) {
...
function normalizeArrayInput<T>(values: T | T[] | null | undefined): T[] {
