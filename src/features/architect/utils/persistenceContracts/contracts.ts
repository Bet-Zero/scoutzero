/**
 * FILE: src/features/architect/utils/persistenceContracts/contracts.ts
...
export interface PersistenceContract {
  ...
  deepRules: PersistenceDeepRules | null;
}

export interface PersistenceContractsMap {
  TEAM: PersistenceContract;
  PLAYER: PersistenceContract;
  EVENT: PersistenceContract;
  EVENT_METADATA: PersistenceContract;
}
 ...
 */
export const DEAD_CAP_ITEM_ALLOWLIST: PersistenceAllowlist = Object.freeze([
  'playerId',
  'playerName',
  'originalSalary',
 ...
 */
export const CAP_HOLD_ITEM_ALLOWLIST: PersistenceAllowlist = Object.freeze([
  'playerId',
  'playerName',
  'amount',
  'type',
 ...
 */
export const EVENT_TOP_LEVEL_ALLOWLIST: PersistenceAllowlist = Object.freeze([
 ...
 */
export const TEAM_DEEP_RULES: PersistenceDeepRules = Object.freeze({
 ...
 */
export const PERSISTENCE_CONTRACTS: PersistenceContractsMap = Object.freeze({
  TEAM: {
