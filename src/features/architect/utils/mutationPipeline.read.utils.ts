/**
 * Wave 35: Read-phase utility functions extracted from mutationPipeline.read.ts
 * (lines 431–940). Sanitization, validation, error helpers, S&T authority
 * summary, world-time SSOT, and trade payload builder.
 */

import { getDoc } from 'firebase/firestore';
import { toEndYear } from '@/features/architect/utils/seasonFormat';
import { worldMetadataRef } from '@/features/architect/utils/architectFirestorePaths';
import {
  validateSigning,
  isOverrideEnabled,
