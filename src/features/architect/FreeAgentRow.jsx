...
const FreeAgentRow = ({ player = {}, askInfo = {}, onSelect, isSelected = false }) => {
  ...
  const asking = askInfo.askingSalary != null
  ...
  return (
    ...
    >
      <div className="h-[45px] w-[50px] bg-[#2a2a2a] flex items-center justify-center overflow-hidden rounded-sm">
        <img
          src={player.headshotUrl || `/assets/headshots/${player.player_id}.png`}
          onError={(e) => {
