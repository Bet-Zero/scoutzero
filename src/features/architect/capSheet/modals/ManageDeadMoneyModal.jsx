      ...
      <div className="bg-[#1a1a1a] border border-white/10 rounded-lg shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4">
          <div className="mb-4 text-sm text-white/60 bg-blue-500/10 border border-blue-500/20 p-3 rounded">
            <p><strong>Manual Override Mode:</strong> Use this tool to correct data errors or add legacy dead money tables. Changes here will replace the team's entire dead money ledger.</p>
          </div>
                ...
                <tr key={entry.id} className="group hover:bg-white/5">
                  <td className="p-2">
                    <input 
                      type="text" 
                      value={entry.label} 
                      onChange={(e) => handleChange(entry.id, 'label', e.target.value)}
                  ...
                  <td className="p-2">
                    <input 
                      ...
                      onChange={(e) => handleChange(entry.id, 'seasonKey', e.target.value)}
                  ...
                  <td className="p-2 text-center">
                    <input 
                      ...
                      onChange={(e) => handleChange(entry.id, 'stretched', e.target.checked)}
