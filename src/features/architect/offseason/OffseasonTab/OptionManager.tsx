/**
 * FILE: src/features/architect/offseason/OffseasonTab/OptionManager.tsx
...
const getContractYearSlice = (
  player: OffseasonPlayer | null | undefined,
  endYear: number
): OffseasonContractYearSlice | null => {
...
const OptionManager = ({
  ...
  const [optionsList, setOptionsList] = useState<OffseasonOptionRow[]>([]);
  const [decisions, setDecisions] = useState<OffseasonOptionDecisionMap>({});
  ...
  useEffect(() => {
    ...
    const options = players
      ...
      .filter((option): option is OffseasonOptionRow => Boolean(option));

    setOptionsList(options);

    const initialDecisions: OffseasonOptionDecisionMap = {};
    options.forEach((opt) => {
