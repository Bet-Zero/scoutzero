...
type ValidationIssueLike = unknown;
...
interface TeamRulesLike {
  ...
  hardCap?: HardCapRuleLike | null;
  [key: string]: unknown;
}

interface SalaryMatchingCalculationsLike {
  margin?: number | null;
  [key: string]: unknown;
}

interface TeamCalculationsLike {
  salaryOut?: number | null;
  salaryIn?: number | null;
  salaryMatching?: SalaryMatchingCalculationsLike | null;
  [key: string]: unknown;
}
...
interface TeamResultLike {
  ...
  calculations?: TeamCalculationsLike | null;
  salaryOut?: number | null;
  salaryIn?: number | null;
  rules?: TeamRulesLike | null;
  projectedSalary?: number | null;
  hardCapped?: unknown;
  violations?: ValidationIssueLike[] | null;
  legal?: boolean | null;
  capRoom?: number | null;
  [key: string]: unknown;
}
...
interface TeamSnapshot {
  ...
  salaryMatchingApplicable: boolean;
  salaryMatchingSkipReason: string | null;
  salaryMatchingRule: string;
  salaryMatchingFormula: string;
  margin: number | null;
  salaryMatchingPassed: boolean;
...
interface TradeSnapshot {
  ...
  seasonKey: string | null;
  capSettings: unknown;
  allViolations: ValidationIssueLike[];
...
export function getTeamSnapshot(
  ...
  result: ValidationResultLike | null | undefined
): TeamSnapshot | null {
 ...
 * @returns {Object|null} Team snapshot with legality-affecting values, or null if not available
 */
export function getTeamSnapshotByIndex(
