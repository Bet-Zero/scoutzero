...
const PlayerHeader = ({ player, selectedPlayer }) => {
  ...
  const freeAgentType = player.freeAgentType; // v2 canonical name
  const freeAgentYear = player.freeAgentYear; // v2 canonical name
    ...
    <div className="h-[220px] w-full max-w-[750px] flex items-center gap-4">
      <div className="flex w-[300px] justify-between">
        <div className="flex flex-col justify-center">
          <PlayerName name={player.bio?.displayName || 'Unknown'} />
