...
/architect_worlds/{worldId}        # World info (~2 KB per world)
/architect_worlds/{worldId}/teams/{teamCode}  # Only modified teams
```
...
getTeam(worldId, teamCode) {
  1. Try world snapshot: /architect_worlds/{worldId}/teams/{teamCode}
