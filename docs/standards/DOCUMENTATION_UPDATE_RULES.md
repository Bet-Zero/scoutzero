...
- [ ] **Run `npm run schema:generate`**
  - Auto-generates `docs/reference/schema/*.md` files
...
- `docs/reference/schema/*.md` (generated by `npm run schema:generate`)
...
**See `docs/standards/CREATING_PERMANENT_DOCS.md` for detailed guidance on:**
