...
| Substep | Description                                                                                                     | Status |
| ------- | --------------------------------------------------------------------------------------------------------------- | ------ |
| TH-3A   | Tighten The Team History Normalization Contract So Category / Type / Summary Output Is More Explicitly Grounded | TODO   |
| TH-3B   | Tighten Cap-Delta And Detail-Section Interpretation So Display Rows Preserve More Real Event Truth              | TODO   |
