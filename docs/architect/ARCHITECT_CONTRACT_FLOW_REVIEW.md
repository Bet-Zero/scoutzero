...
- `tests/validators/roster.test.js` — 2 failed tests.
- `src/tests/architect/architectTsTopologyCleanup.behavior.test.ts` — 1 timed-out test.
- `src/tests/architect/editContractModal_closure.gate.test.ts` — 1 failed stale gate.
- `src/tests/architect/freeAgency_closure.gate.test.ts` — 2 failed stale gates.
