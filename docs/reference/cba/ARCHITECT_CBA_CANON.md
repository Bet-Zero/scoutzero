...
**Current R3.1 accepted status (supersedes the R2.13 sequencing sentence above):**
...
`/root/validation_scout`. R3 remains rejected; its historical 81-LEAF
...
`30808340f28edd334222a5cdd9de4dbdc809f32f`. The R5 maker has now
source-certified C14–C25; independent R5 review remains pending, so R5 is not
accepted and R6 remains blocked and unstarted. Phase 1 continues; Phase 2 and
W1.1 remain blocked pending R9 ACCEPT plus owner acceptance.
...
| **Repair v2.0 — working draft, R5 maker** | **July 26, 2026** | **C-series second-half source certification:** adds 12 GROUPs and 250 atomic or explicitly staged C14–C25 LEAFs, `XW2-0279`–`XW2-0356`, `EV2-0280`–`EV2-0529`, and `DR2-0117`–`DR2-0123`; maps all 79 published C14–C25 rows together with accepted `XW2-0154`; and records three exact process-only historical statements without treating them as NBA rules. Signed-CBA primary authority only; no schema, validator, registry, proof, or lineage expansion. **Maker checkpoint only — independent R5 checker pending; R6 remains blocked and unstarted.** Receipt: `work/architect-completion/ARCHITECT_CBA_CANON_V2_R5_C_SERIES_SECOND_HALF_CERTIFICATION.md`. |
...
`4fc3ed90cb108b155e24670eaf2d5942f6a2479b` was independently **ACCEPTED**
by `/root/r4_checker` at checker commit
`30808340f28edd334222a5cdd9de4dbdc809f32f`. R5 maker construction is now
complete; independent R5 review remains pending and R6 remains blocked and
unstarted. Phase 1 continues, and Phase 2/W1.1 remain blocked pending R9
ACCEPT plus owner acceptance. "Mechanical"
...
`4fc3ed90cb108b155e24670eaf2d5942f6a2479b` was independently **ACCEPTED**
by `/root/r4_checker` at checker commit
`30808340f28edd334222a5cdd9de4dbdc809f32f`. At that acceptance point, R4 is
unblocked but remains not started. R5 has now extended the same governed
populations with C14–C25 at a maker-only checkpoint. Independent R5 review
remains pending, R6 remains blocked and unstarted, and this is Phase 1
construction rather than final canon activation: scenario evidence remains
pending R7, Phase 1 continues, and nothing here carries a Phase 2 verdict
before R9 ACCEPT plus owner acceptance.
...
| CBA2-C14 | Veteran Free Agent status and Bird rights — Are Bird classifications, signing authority, renunciation, and one-year consent consequences applied from exact service and transaction history? | `CBA2-C14.1`–`CBA2-C14.24` (24) | GROUP anchor; no obligation, verdict, method, locator, or evidence |
| CBA2-C15 | Arenas Offer Sheets — Are one- and two-YOS Offer Sheets shaped and charged differently for offering and matching Teams? | `CBA2-C15.1`–`CBA2-C15.12` (12) | GROUP anchor; no obligation, verdict, method, locator, or evidence |
| CBA2-C16 | Rookie Scale, maximum salary, and extensions — Are rookie contracts, maximums, award overlays, and extension routes enforced independently? | `CBA2-C16.1`–`CBA2-C16.37` (37) | GROUP anchor; no obligation, verdict, method, locator, or evidence |
| CBA2-C17 | Over-38 attribution — Are age triggers, zero Seasons, special QVFA treatment, and July 1 reattribution applied exactly? | `CBA2-C17.1`–`CBA2-C17.9` (9) | GROUP anchor; no obligation, verdict, method, locator, or evidence |
| CBA2-C18 | Signing and Extension bonuses — Are ordinary, trade-earned, and Extension bonuses allocated under the correct timing and protection branches? | `CBA2-C18.1`–`CBA2-C18.13` (13) | GROUP anchor; no obligation, verdict, method, locator, or evidence |
| CBA2-C19 | Ten-Day and Rest-of-Season Contracts — Are entry dates, capacity, duration, termination, and proration rules enforced? | `CBA2-C19.1`–`CBA2-C19.20` (20) | GROUP anchor; no obligation, verdict, method, locator, or evidence |
| CBA2-C20 | Two-Way Contracts — Are roster, compensation, eligibility, conversion, usage, protection, and rights rules enforced independently? | `CBA2-C20.1`–`CBA2-C20.31` (31) | GROUP anchor; no obligation, verdict, method, locator, or evidence |
| CBA2-C21 | Exhibits 9 and 10 and Summer Contracts — Are contract shape, roster limits, payment, conversion, protection, and Team Salary timing enforced? | `CBA2-C21.1`–`CBA2-C21.33` (33) | GROUP anchor; no obligation, verdict, method, locator, or evidence |
| CBA2-C22 | Protection and compensation progression — Are protection limits, Minimum exceptions, maximum adjustments, and annual changes applied in order? | `CBA2-C22.1`–`CBA2-C22.14` (14) | GROUP anchor; no obligation, verdict, method, locator, or evidence |
| CBA2-C23 | Special compensation limits — Are incentive, signing-bonus, deferral, international-player payment, loan, and premium rules enforced? | `CBA2-C23.1`–`CBA2-C23.27` (27) | GROUP anchor; no obligation, verdict, method, locator, or evidence |
| CBA2-C24 | Options and ETOs — Are shape, protection, deadlines, notices, and extension interactions enforced? | `CBA2-C24.1`–`CBA2-C24.17` (17) | GROUP anchor; no obligation, verdict, method, locator, or evidence |
| CBA2-C25 | Retired, pending, circumvention, and grievance amounts — Are residual Team Salary components included and reconciled? | `CBA2-C25.1`–`CBA2-C25.13` (13) | GROUP anchor; no obligation, verdict, method, locator, or evidence |
...
| CBA2-C14.1 | Bird-status classification must evaluate the Full Bird, Early Bird, and Non-Bird definitions from the player’s exact service and team-change history | INFERRED | SCEN | — | EV2-0280 | XW2-0279, XW2-0284, XW2-0285 | Classification inference over direct definitions; direct owners control. |
| CBA2-C14.2 | Qualifying Veteran Free Agent status requires three immediately preceding Seasons of Service with the Prior Team, subject only to the signed trade, first-season waiver-claim, and first-season signing continuity routes | CBA | SCEN | — | EV2-0281 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.3 | Early Qualifying Veteran Free Agent status requires two immediately preceding Seasons of Service with the Prior Team under the signed continuity routes | CBA | SCEN | — | EV2-0282 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.4 | A Veteran Free Agent who is neither Qualifying nor Early Qualifying is a Non-Qualifying Veteran Free Agent | CBA | SCEN | — | EV2-0283 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.5 | Renouncing a Veteran Free Agent removes his Free Agent Amount and loses the Team’s right to use the Qualifying or Early Qualifying Veteran Free Agent Exception for him | CBA | SCEN | — | EV2-0284 | XW2-0280 | One independently judgeable source result. |
| CBA2-C14.6 | A Team may not renounce a Veteran Free Agent before July 1 following the last Season of his Contract | CBA | SCEN | — | EV2-0285 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.7 | A Team may not renounce a Restricted Free Agent while he remains subject to a Right of First Refusal | CBA | SCEN | — | EV2-0286 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.8 | Renunciation changes the current hold and signing route but does not rewrite service and team-change history used by a later Bird classification | INFERRED | SCEN | — | EV2-0287 | new (DR2-0119) | Aggregate or classification inference; direct owners control. |
| CBA2-C14.9 | A Team may elect in writing to treat an Early Qualifying Veteran Free Agent as Non-Qualifying for the new Contract | CBA | SCEN | — | EV2-0288 | XW2-0281 | One independently judgeable source result. |
| CBA2-C14.10 | A Qualifying Veteran Free Agent may receive first-year Salary plus Unlikely Bonuses up to his applicable Maximum Annual Salary | CBA | SCEN | — | EV2-0289 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.11 | A Qualifying Veteran Free Agent Contract may cover no more than five Seasons | CBA | SCEN | — | EV2-0290 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.12 | A Qualifying Veteran Free Agent Contract may use annual changes up to eight percent of first-year Regular Salary | CBA | SCEN | — | EV2-0291 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.13 | An Early Qualifying Veteran Free Agent’s first-year Salary plus Unlikely Bonuses may not exceed the greater of 175% of prior Regular Salary plus prior Likely Bonuses or 105% of Estimated Average Player Salary, subject to the maximum | CBA | SCEN | — | EV2-0292 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.14 | An Early Qualifying Veteran Free Agent Contract must cover at least two and no more than four Seasons, excluding an Option Year from the minimum | CBA | SCEN | — | EV2-0293 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.15 | An Early Qualifying Veteran Free Agent Contract may use annual changes up to eight percent of first-year Regular Salary | CBA | SCEN | — | EV2-0294 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.16 | A Non-Qualifying Veteran Free Agent’s first-year Salary plus Unlikely Bonuses may not exceed the greatest of 120% of prior Regular Salary plus prior Likely Bonuses, 120% of the applicable Minimum Player Salary, or his Qualifying Offer, subject to the maximum | CBA | SCEN | — | EV2-0295 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.17 | A Non-Qualifying Veteran Free Agent Contract may cover no more than four Seasons | CBA | SCEN | — | EV2-0296 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.18 | A Non-Qualifying Veteran Free Agent Contract may use annual changes up to five percent of first-year Regular Salary | CBA | SCEN | — | EV2-0297 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.19 | A non-Two-Way one-season Contract that would leave the player Qualifying or Early Qualifying after the Season may not be traded without consent unless the signing-time elimination route applies | CBA | SCEN | — | EV2-0298 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.20 | After a trade under the one-season consent rule, the player is treated for Bird status as having signed with the assignee as a free agent, except after exercise of a second-season Team or Player Option | CBA | SCEN | — | EV2-0299 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.21 | A one-season trade-consent right continues on later assignments unless waived at signing or by affirmative transaction consent | CBA | SCEN | — | EV2-0300 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C14.22 | Bird first-year signing authority must use the independently applicable Full Bird, Early Bird, or Non-Bird ceiling | INFERRED | SCEN | — | EV2-0301 | XW2-0282 | Aggregate or classification inference; direct owners control. |
| CBA2-C14.23 | Bird Contract term and annual-change compliance requires the independently applicable status-specific term and raise rules | INFERRED | SCEN | — | EV2-0302 | XW2-0283 | Aggregate or classification inference; direct owners control. |
| CBA2-C14.24 | One-season Bird-right trade treatment requires the consent predicate, post-trade status consequence, and waiver state to be applied independently | INFERRED | SCEN | — | EV2-0303 | XW2-0286, XW2-0287 | Aggregate or classification inference; direct owners control. |
| CBA2-C15.1 | An offering Team must preserve sufficient Room for a one- or two-YOS Veteran Free Agent Offer Sheet until it ends or is matched | CBA | SCEN | — | EV2-0304 | XW2-0288 | One independently judgeable source result. |
| CBA2-C15.2 | The ROFR Team must preserve the Room or exception authority required to match an outstanding Offer Sheet throughout the matching period | CBA | SCEN | — | EV2-0305 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C15.3 | A qualifying one- or two-YOS Offer Sheet’s first-year Salary plus Unlikely Bonuses may not exceed the NTMLE amount | CBA | SCEN | — | EV2-0306 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C15.4 | Its second-year Salary plus Unlikely Bonuses may increase or decrease by no more than five percent of first-year Regular Salary | CBA | SCEN | — | EV2-0307 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C15.5 | Its third-year Salary may jump to the offering Team’s maximum only when the first two Seasons use the permitted maximum amounts | CBA | SCEN | — | EV2-0308 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C15.6 | Its fourth-year Salary may change by no more than 4.5% of third-year Regular Salary | CBA | SCEN | — | EV2-0309 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C15.7 | Its third and fourth Seasons may contain no bonuses and must be fully protected for lack of skill and injury or illness without individually negotiated conditions | CBA | SCEN | — | EV2-0310 | new (DR2-0119) | One independently judgeable later-year condition set. |
| CBA2-C15.8 | The offering Team must have Room for Average Annual Salary and, if unmatched, includes that average in Team Salary for every covered Season | CBA | SCEN | — | EV2-0311 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C15.9 | A matching ROFR Team ordinarily includes the stated annual Arenas salary schedule in Team Salary | CBA | SCEN | — | EV2-0312 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C15.10 | A qualifying below-cap ROFR Team may elect to use Average Annual Salary instead of the stated schedule | CBA | SCEN | — | EV2-0313 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C15.11 | The ROFR Team’s averaging election requires a written NBA statement on the same day as its First Refusal Exercise Notice; the NBA must copy the Players Association within one business day | CBA | SCEN | — | EV2-0314 | new (DR2-0119) | Election notice and NBA relay deadlines are the signed notice chain. |
| CBA2-C15.12 | Arenas compliance requires the offer-year limits, later-year conditions, and each Team’s accounting treatment to pass independently | INFERRED | SCEN | — | EV2-0315 | XW2-0289 | Aggregate or classification inference; direct owners control. |
| CBA2-C16.1 | A Rookie Scale Contract covers four Seasons: two initial Seasons followed by Team Options for the third and fourth Seasons | CBA | SCEN | — | EV2-0316 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.2 | Rookie Scale Salary plus Unlikely Bonuses must be at least 80% and no more than 120% of the applicable Rookie Scale Amount, subject to the Minimum Player Salary floor | CBA | SCEN | — | EV2-0317 | XW2-0291 | One independently judgeable source result. |
| CBA2-C16.3 | A First Round Pick signing on or after January 10 receives the applicable amount prorated over remaining Regular Season days | CBA | SCEN | — | EV2-0318 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.4 | A Rookie Scale Team Option must be exercised by October 31 before the option Season, extended to the next business day for a weekend or federal holiday | CBA | SCEN | — | EV2-0319 | XW2-0292 | One independently judgeable source result. |
| CBA2-C16.5 | Rookie Scale Team Option exercise requires written notice to the player and NBA | CBA | SCEN | — | EV2-0320 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.6 | Failure to exercise either Rookie Scale Team Option makes the player an Unrestricted Free Agent after the preceding Season | CBA | SCEN | — | EV2-0321 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.7 | After declining a Rookie Scale Team Option, the Prior Team may not offer first-year Salary plus Unlikely Bonuses above the declined amount | CBA | SCEN | — | EV2-0322 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.8 | The fourth-Season Rookie Scale Team Option carries the third-Season option’s terms and protection except for its prescribed salary schedule | CBA | SCEN | — | EV2-0323 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.9 | A Rookie Scale Contract may not include a signing bonus or loan except for permitted international-player treatment | CBA | SCEN | — | EV2-0324 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.10 | Maximum Annual Salary is tested against first-Season Salary plus Unlikely Bonuses | CBA | SCEN | — | EV2-0325 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.11 | For fewer than seven YOS, Maximum Annual Salary is the greater of 25% of the Salary Cap or 105% of prior Salary | CBA | SCEN | — | EV2-0326 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.12 | For seven through nine YOS, Maximum Annual Salary is the greater of 30% of the Salary Cap or 105% of prior Salary | CBA | SCEN | — | EV2-0327 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.13 | For ten or more YOS, Maximum Annual Salary is the greater of 35% of the Salary Cap or 105% of prior Salary | CBA | SCEN | — | EV2-0328 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.14 | Fifth Year Eligible Players may receive the Higher Max only through the specified MVP, Defensive Player of the Year, or All-NBA achievement alternatives and lookbacks | CBA | SCEN | — | EV2-0329 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.15 | Awards used for a Higher Max or Designated Veteran route must satisfy the Article XXIX §6 game threshold or an applicable injury or grievance determination | CBA | SCEN | EXTS | EV2-0330 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.16 | A Designated Veteran Player Contract requires the signed draft-team or trade-history route, Qualifying Veteran Free Agent status, and seven or eight YOS | CBA | SCEN | — | EV2-0331 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.17 | A Designated Veteran Player Contract may set first-year Salary between 30% and 35% of the Salary Cap as agreed | CBA | SCEN | — | EV2-0332 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.18 | A Rookie Scale Extension requires exercise of both Rookie Scale Team Options | CBA | SCEN | — | EV2-0333 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.19 | A Rookie Scale Extension may be signed only from the end of the July moratorium through 6 p.m. on the day before the fourth Contract Season’s first Regular Season game | CBA | SCEN | — | EV2-0334 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.20 | First-year Salary in a Rookie Scale Extension may reach the applicable Maximum Annual Salary | CBA | SCEN | — | EV2-0335 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.21 | A Rookie Scale Extension may state a conditional first-year percentage between 25% and 30% of the Salary Cap under the Higher Max conditions | CBA | SCEN | — | EV2-0336 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.22 | A Rookie Scale Extension’s term and annual changes must follow the signed limits, with changes no greater than eight percent of first-year Regular Salary | CBA | SCEN | — | EV2-0337 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.23 | A three- or four-Season Veteran Contract may first be extended on its second anniversary, a five- or six-Season Contract on its third, and one- or two-Season Contracts are not extendable | CBA | SCEN | — | EV2-0338 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.24 | A Veteran Extension generally requires no more than one Season remaining; when more remains, the CBA’s offseason restriction applies | CBA | SCEN | — | EV2-0339 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.25 | Ordinary first-year extended Salary may not exceed the greater of 140% of final Regular Salary and 140% of EAPS, subject to the maximum | CBA | SCEN | — | EV2-0340 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.26 | First-year extended Likely and Unlikely Bonuses must use the signed separate 140% and carry-forward adjustments | CBA | SCEN | — | EV2-0341 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.27 | An ordinary Veteran Extension may add no more than four Seasons and may use annual changes no greater than eight percent | CBA | SCEN | — | EV2-0342 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.28 | A Designated Veteran Extension requires the original-team or permitted trade-history route, seven or eight YOS, and Qualifying Veteran status | CBA | SCEN | — | EV2-0343 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.29 | A Designated Veteran Extension requires a specified MVP, Defensive Player of the Year, or All-NBA achievement alternative | CBA | SCEN | — | EV2-0344 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.30 | A Designated Veteran Extension must cover the designated term and may set first-year extended Salary between 30% and 35% of the Salary Cap | CBA | SCEN | — | EV2-0345 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.31 | A Contract containing a Designated Veteran Extension may not be traded for one year after signing | CBA | SCEN | — | EV2-0346 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C16.32 | A Designated Veteran Extension may not include Incentive Compensation | CBA | SCEN | — | EV2-0347 | XW2-0303 | One independently judgeable source result. |
| CBA2-C16.33 | A player not selected in an NBA Draft becomes a Rookie Free Agent immediately after that Draft and may sign only through an independently valid mechanism | CBA | SCEN | — | EV2-0348 | XW2-0324 | One independently judgeable source result. |
| CBA2-C16.34 | Rookie Scale Contract compliance requires shape, salary range, option timing and notice, declined-option consequences, and compensation restrictions | INFERRED | SCEN | — | EV2-0349 | XW2-0290, XW2-0293 | Aggregate or classification inference; direct owners control. |
| CBA2-C16.35 | Maximum-salary compliance requires the YOS tier, 105%-of-prior branch, and any Higher Max or designated route | INFERRED | SCEN | — | EV2-0350 | XW2-0295, XW2-0296 | Aggregate or classification inference; direct owners control. |
| CBA2-C16.36 | Rookie Scale Extension compliance requires exercised options, signing window, starting maximum, term, and raise rules | INFERRED | SCEN | — | EV2-0351 | XW2-0297, XW2-0298, XW2-0299 | Aggregate or classification inference; direct owners control. |
| CBA2-C16.37 | Veteran and Designated Veteran Extension compliance requires timing, compensation, term, status, awards, trade, and incentive rules | INFERRED | SCEN | — | EV2-0352 | XW2-0300, XW2-0301, XW2-0302 | Aggregate or classification inference; direct owners control. |
| CBA2-C17.1 | The general Over-38 rule applies to a Contract, Extension, or Renegotiation covering at least four Seasons and a Season after the player turns 38 | CBA | SCEN | — | EV2-0353 | XW2-0304 | One independently judgeable source result. |
| CBA2-C17.2 | Over-38 age is ordinarily measured on October 1 of the covered Season | CBA | SCEN | — | EV2-0354 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C17.3 | For a July-moratorium Contract and a birthday in that period, Over-38 age is measured as of the preceding June 30 | CBA | SCEN | — | EV2-0355 | XW2-0305 | One independently judgeable source result. |
| CBA2-C17.4 | The general first zero-attribution Season is the later of the fourth Contract Season or the first October 1 on which the player is 38 | CBA | SCEN | — | EV2-0356 | XW2-0306 | One independently judgeable source result. |
| CBA2-C17.5 | Salary from an Over-38 zero Season is allocated proportionally among non-zero Seasons under the signed formula | CBA | SCEN | — | EV2-0357 | XW2-0308 | One independently judgeable source result. |
| CBA2-C17.6 | A 35- or 36-year-old QVFA re-signing with the Prior Team avoids reallocation for no more than four Seasons; on five Seasons only Year 5 is zero | CBA | SCEN | — | EV2-0358 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C17.7 | The 35/36 Qualifying Veteran exception does not apply to a Sign-and-Trade Contract | CBA | SCEN | — | EV2-0359 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C17.8 | Over-38 attribution is recomputed each July 1 beginning two years before the first zero Season while the Contract remains active | CBA | SCEN | — | EV2-0360 | XW2-0309 | One independently judgeable source result. |
| CBA2-C17.9 | Over-38 compliance requires the correct age date, trigger, zero Season, allocation, special QVFA route, and recurring reattribution | INFERRED | SCEN | — | EV2-0361 | XW2-0307 | Aggregate or classification inference; direct owners control. |
| CBA2-C18.1 | An ordinary signing bonus is allocated among Salary Cap Years in proportion to Base Compensation protected for lack of skill | CBA | SCEN | — | EV2-0362 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C18.2 | An ETO Season is excluded from ordinary signing-bonus allocation | CBA | SCEN | — | EV2-0363 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C18.3 | If no future Season has protected Base Compensation, the unallocated ordinary signing bonus is attributed to the first Salary Cap Year | CBA | SCEN | — | EV2-0364 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C18.4 | A trade bonus earned during a Contract is allocated only to the current and remaining Salary Cap Years under protected-percentage rules | CBA | SCEN | — | EV2-0365 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C18.5 | An Extension bonus paid at or above the Cap may be paid no sooner than the first extended Salary Cap Year and is allocated only over the extended term | CBA | SCEN | — | EV2-0366 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C18.6 | If no extended Season has protected Base Compensation in that branch, the bonus is attributed to the first extended Salary Cap Year | CBA | SCEN | — | EV2-0367 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C18.7 | A below-cap Extension bonus paid on or after the first extended Salary Cap Year uses the same extended-term-only allocation and fallback | CBA | SCEN | — | EV2-0368 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C18.8 | A below-cap Extension bonus paid early is allocated over remaining original and extended Seasons by protected Base Compensation, with zero in the signing year | CBA | SCEN | — | EV2-0369 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C18.9 | A below-cap early-paid Extension bonus is deemed a Renegotiation for Salary Cap purposes | CBA | SCEN | — | EV2-0370 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C18.10 | A below-cap early-paid Extension bonus must be paid in two equal installments on the specified dates | CBA | SCEN | — | EV2-0371 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C18.11 | If an Extension removes the original trade-bonus provision, a previously earned trade bonus remains allocated over the original term only | CBA | SCEN | — | EV2-0372 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C18.12 | If an Extension retains the trade-bonus provision, the signed assumed-trade, installment, and maximum-adjustment rules govern extended allocation | CBA | SCEN | — | EV2-0373 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C18.13 | General signing-bonus allocation requires the protected-percentage basis, ETO exclusion, zero-protection fallback, and trade-earned remaining-year boundary | INFERRED | SCEN | — | EV2-0374 | XW2-0311 | Aggregate or classification inference; direct owners control. |

| CBA2-C19.1 | A Team may first enter a Ten-Day Contract on January 5 | CBA | SCEN | — | EV2-0375 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.2 | A Ten-Day Contract lasts the longer of ten days or three scheduled team games | CBA | SCEN | — | EV2-0376 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.3 | A Ten-Day Contract must pay at least the applicable Minimum Player Salary prorated for its stated term | CBA | SCEN | — | EV2-0377 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.4 | A Team may sign the same player to no more than two Ten-Day Contracts in one Season | CBA | SCEN | — | EV2-0378 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.5 | Concurrent ordinary Ten-Day capacity is zero, one, two, or three for respectively 12, 13, 14, or 15 Standard roster players | CBA | SCEN | — | EV2-0379 | XW2-0313 | One independently judgeable source result. |
| CBA2-C19.6 | A hardship Ten-Day Contract may be entered outside the ordinary January 5 window when the hardship authorization applies | CBA | SCEN | — | EV2-0380 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.7 | A hardship Ten-Day Contract may use the shorter term authorized by the hardship provision | CBA | SCEN | — | EV2-0381 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.8 | A Ten-Day Contract may not have a stated term extending to or beyond the Team’s last Regular Season game | CBA | SCEN | — | EV2-0382 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.9 | Written termination of a Ten-Day Contract is effective immediately without waivers | CBA | SCEN | — | EV2-0383 | XW2-0314 | One independently judgeable source result. |
| CBA2-C19.10 | After Ten-Day termination, the Team owes only compensation earned through termination and expressly accrued amounts | CBA | SCEN | — | EV2-0384 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.11 | A player whose Ten-Day Contract was terminated may not sign another NBA Contract before the original stated term expires | CBA | SCEN | — | EV2-0385 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.12 | During a Ten-Day Contract, the parties may negotiate a Rest-of-Season Contract effective the day after the stated Ten-Day term expires | CBA | SCEN | — | EV2-0386 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.13 | A Rest-of-Season Contract may be entered only after the first Regular Season day and covers compensation for the remainder of that Season | CBA | SCEN | — | EV2-0387 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.14 | A Rest-of-Season Contract must provide at least the applicable Minimum Player Salary prorated for remaining Regular Season days | CBA | SCEN | — | EV2-0388 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.15 | A Two-Way Contract is not a Rest-of-Season Contract for Article II §10 | CBA | SCEN | — | EV2-0389 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.16 | Rest-of-Season proration multiplies the full-season amount by remaining Regular Season days divided by total Regular Season days | CBA | SCEN | — | EV2-0390 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C19.17 | A prorated Rest-of-Season Salary must flow consistently into each ledger or exception calculation that consumes that Salary | INFERRED | SCEN | — | EV2-0391 | XW2-0316 | Aggregate inference; direct owners control. |
| CBA2-C19.18 | Ten-Day compliance requires the opening, duration, minimum, count, capacity, hardship, final-game, and termination rules | INFERRED | SCEN | — | EV2-0392 | XW2-0312 | Aggregate inference; direct owners control. |
| CBA2-C19.19 | Rest-of-Season compliance requires timing, current-Season compensation, future-term availability, minimum, exclusion, and proration rules | INFERRED | SCEN | — | EV2-0393 | XW2-0315 | Aggregate inference; direct owners control. |
| CBA2-C20.1 | A Team may have no more than three Two-Way Players on its roster at one time | CBA | SCEN | — | EV2-0394 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.2 | A Two-Way Player does not occupy a Standard Active or Inactive List position | CBA | SCEN | — | EV2-0395 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.3 | Two-Way Salary is excluded from Team Salary | CBA | SCEN | — | EV2-0396 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.4 | Full-season Two-Way Base Compensation equals 50% of the zero-YOS Minimum Player Salary | CBA | SCEN | — | EV2-0397 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.5 | A Two-Way signed after the Season begins prorates Base Compensation over remaining Regular Season days | CBA | SCEN | — | EV2-0398 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.6 | A Two-Way Contract may not include bonuses | CBA | SCEN | — | EV2-0399 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.7 | A Two-Way Contract may not include Incentive Compensation | CBA | SCEN | — | EV2-0400 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.8 | A Two-Way Contract may not include deferred compensation | CBA | SCEN | — | EV2-0401 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.9 | A Two-Way Contract may not include a loan | CBA | SCEN | — | EV2-0402 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.10 | Two-Way Advance compliance requires the signing-time protection, payment-date, amount-limit, and installment-deduction rules to pass independently | INFERRED | SCEN | — | EV2-0403 | new (DR2-0119) | Aggregate inference; direct owners control. |
| CBA2-C20.11 | A Two-Way Contract may cover no more than two Seasons | CBA | SCEN | — | EV2-0404 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.12 | A Two-Way Contract may not include an Option Year | CBA | SCEN | — | EV2-0405 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.13 | A Two-Way Contract may not include an Early Termination Option | CBA | SCEN | — | EV2-0406 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.14 | A player generally must have fewer than four YOS when a Two-Way Contract is signed | CBA | SCEN | — | EV2-0407 | XW2-0319 | One independently judgeable source result. |
| CBA2-C20.15 | A four-YOS player may sign only the narrow one-Season Two-Way permitted by the signed exception | CBA | SCEN | — | EV2-0408 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.16 | A player may not be under a Two-Way with the same Team in more than three Salary Cap Years | CBA | SCEN | — | EV2-0409 | XW2-0320 | One independently judgeable source result. |
| CBA2-C20.17 | A Team may not sign a player to a Two-Way Contract after March 4 of that Season | CBA | SCEN | — | EV2-0410 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.18 | A Two-Way conversion may occur from July 1 through the day before the Team’s final Regular Season game | CBA | SCEN | — | EV2-0411 | XW2-0323 | One independently judgeable source result. |
| CBA2-C20.19 | A Standard Conversion Option produces a Standard Contract at the applicable Minimum Player Salary | CBA | SCEN | — | EV2-0412 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.20 | The converted Standard Contract keeps the same remaining term, with compensation credited as the signed rule requires | CBA | SCEN | — | EV2-0413 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.21 | A newly negotiated Standard replacement requires independently available Room or exception authority | CBA | SCEN | — | EV2-0414 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.22 | A newly negotiated Standard replacement may not include Exhibit 10 and immediately voids the prior Two-Way | CBA | SCEN | — | EV2-0415 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.23 | A Two-Way player may be on the Active List for no more than 50 games, prorated for a partial Season and never below one game | CBA | SCEN | — | EV2-0416 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.24 | A Team may use Two-Way Players in no more than 90 weighted Under-Fifteen Games, counting one, two, or three for the number active in each such game | CBA | SCEN | — | EV2-0417 | new (DR2-0119) | One closed weighted-usage calculation. |
| CBA2-C20.25 | Two-Way Compensation Protection may not exceed $75,000 scaled from the 2023-24 Salary Cap before the Season, or 50% of Contract Base Compensation after the first Regular Season day | CBA | SCEN | — | EV2-0418 | new (DR2-0119) | One timing-routed maximum. |
| CBA2-C20.26 | Excess Two-Way protection after assignment or termination triggers the signed affiliate and same-Team restrictions | CBA | SCEN | — | EV2-0419 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.27 | A Team retains exclusive NBA negotiating rights to its Two-Way player until a signed conversion, replacement, assignment, or termination event | CBA | SCEN | — | EV2-0420 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.28 | Two-Way compliance requires roster, salary, compensation shape, term, eligibility, timing, conversion, usage, protection, and rights rules | INFERRED | SCEN | — | EV2-0421 | XW2-0318, XW2-0321, XW2-0322 | Aggregate inference; direct owners control. |
| CBA2-C21.1 | Exhibit 9 contract-shape compliance requires its term, salary, bonus, and protection rules to pass independently | INFERRED | SCEN | — | EV2-0422 | new (DR2-0119) | Aggregate inference; direct owners control. |
| CBA2-C21.2 | An Exhibit 9 Team must have at least 14 other players under non-Exhibit-9 Standard Contracts | CBA | SCEN | — | EV2-0423 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.3 | A Team may have no more than six Exhibit 9 Contracts at one time | CBA | SCEN | — | EV2-0424 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.4 | A qualifying Exhibit 9 must provide the cap-indexed injury termination protection amount | CBA | SCEN | — | EV2-0425 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.5 | Exhibit 9 injury protection is eliminated when termination is for lack of skill | CBA | SCEN | — | EV2-0426 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.6 | An Exhibit 10 must attach to a one-Season Standard Contract at the Minimum Player Salary | CBA | SCEN | — | EV2-0427 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.7 | An Exhibit 10 Contract may contain no other bonus or protection beyond the governed Exhibit 10 amounts | CBA | SCEN | — | EV2-0428 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.8 | A Team may have no more than six Exhibit 10 Contracts at one time | CBA | SCEN | — | EV2-0429 | XW2-0328 | One independently judgeable source result. |
| CBA2-C21.9 | An Exhibit 10 bonus must be at least $5,000 and no more than the cap-indexed maximum | CBA | SCEN | — | EV2-0430 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.10 | Exhibit 10 entry compliance requires the waiver, affiliate designation, and timely reporting rules to pass independently | INFERRED | SCEN | — | EV2-0431 | new (DR2-0119) | Aggregate inference; direct owners control. |
| CBA2-C21.11 | The designated player generally must remain with the affiliate for 60 consecutive days | CBA | SCEN | — | EV2-0432 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.12 | The signed Contract interruption and return exception preserves qualifying service only under its timing conditions | CBA | SCEN | — | EV2-0433 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.13 | Signing with another professional team before qualifying affiliate service defeats the Exhibit 10 bonus | CBA | SCEN | — | EV2-0434 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.14 | A qualifying affiliate injury can satisfy the service condition under the signed medical and roster requirements | CBA | SCEN | — | EV2-0435 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.15 | Exhibit 10 conversion to Two-Way must occur before the first Regular Season day and satisfy Article X eligibility | CBA | SCEN | — | EV2-0436 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.16 | Exhibit 10 conversion must apply the separate bonus-rescission and conversion-protection consequences | INFERRED | SCEN | — | EV2-0437 | XW2-0329 | Aggregate inference; direct owners control. |
| CBA2-C21.17 | When both are present, the Exhibit 10 bonus and conversion-protection amount must be equal | CBA | SCEN | — | EV2-0438 | XW2-0330 | One independently judgeable source result. |
| CBA2-C21.18 | Acquiring a converted Exhibit 10 Contract can create a deemed Exhibit 10 bonus under the signed conditions | CBA | SCEN | — | EV2-0439 | XW2-0332 | One independently judgeable source result. |
| CBA2-C21.19 | A qualifying Exhibit 10 bonus is excluded from Team Salary | CBA | SCEN | — | EV2-0440 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.20 | The designating Team must provide the signed returning-rights notice, and failure triggers the stated minimum fine | CBA | SCEN | — | EV2-0441 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.21 | Salary under a Summer Contract is excluded from Team Salary through the day before the first Regular Season day | CBA | SCEN | — | EV2-0442 | XW2-0334 | One independently judgeable source result. |
| CBA2-C21.22 | A Summer Contract retained into the Regular Season requires Room or an applicable exception by the signed deadline | CBA | SCEN | — | EV2-0443 | XW2-0336 | One independently judgeable source result. |
| CBA2-C21.23 | Exhibit 9 compliance requires shape, other-roster count, maximum count, injury protection, and termination basis | INFERRED | SCEN | — | EV2-0444 | XW2-0326, XW2-0333, XW2-0335 | Aggregate inference; direct owners control. |
| CBA2-C21.24 | Exhibit 10 compliance requires shape, count, amount, payment, conversion, acquisition, Team Salary, and notice rules | INFERRED | SCEN | — | EV2-0445 | XW2-0327, XW2-0331 | Aggregate inference; direct owners control. |

| CBA2-C22.1 | A later Season’s lack-of-skill protected percentage generally may not exceed the preceding Season’s protected percentage | CBA | SCEN | — | EV2-0446 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C22.2 | A later protected percentage may exceed the preceding one only when its condition could not be satisfied before the preceding Season ended | CBA | SCEN | — | EV2-0447 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C22.3 | A Minimum Player Salary Contract generally may not include a bonus | CBA | SCEN | — | EV2-0448 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C22.4 | The Minimum Contract bonus bar permits only the signed trade-bonus, Exhibit 10, and international-player payment treatments | CBA | SCEN | — | EV2-0449 | XW2-0338 | One independently judgeable source result. |
| CBA2-C22.5 | A percentage-based future Maximum Annual Salary must be recalculated on the applicable July 1 against the actual Salary Cap | CBA | SCEN | — | EV2-0450 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C22.6 | Excess above the adjusted future maximum is reduced first from signing-bonus allocation | CBA | SCEN | — | EV2-0451 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C22.7 | After signing-bonus allocation is exhausted, remaining excess is reduced from bonus compensation pro rata | CBA | SCEN | — | EV2-0452 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C22.8 | After the first two tiers, remaining excess is reduced from Base Compensation and later annual amounts are adjusted proportionally | CBA | SCEN | — | EV2-0453 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C22.9 | Annual-change compliance requires the ordinary five-percent rule, authorized eight-percent routes, and first-year measurement base | INFERRED | SCEN | — | EV2-0454 | new (DR2-0119) | Aggregate inference; direct owners control. |
| CBA2-C22.10 | Sign-and-Trade and Extension-and-Trade Contracts use their separately stricter annual-change rules | CBA | SCEN | — | EV2-0455 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C22.11 | Compensation-shape compliance requires protection progression, Minimum exceptions, maximum adjustment order, and annual-change rules | INFERRED | SCEN | — | EV2-0456 | XW2-0337, XW2-0339, XW2-0340 | Aggregate inference; direct owners control. |
| CBA2-C23.1 | Total Incentive Compensation in a Season may not exceed 20% of Regular Salary for that Season | CBA | SCEN | — | EV2-0457 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.2 | Unlikely Incentive Compensation in a Season may not exceed 15% of Regular Salary for that Season | CBA | SCEN | — | EV2-0458 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.3 | An Extension may carry forward otherwise excess Unlikely Bonuses only within the exact pre-existing-bonus proviso | CBA | SCEN | — | EV2-0459 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.4 | A Renegotiation may not increase Unlikely Bonuses when the result would exceed 15% of Regular Salary | CBA | SCEN | — | EV2-0460 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.5 | A signing bonus may not exceed 15% of total Compensation excluding Incentive Compensation | CBA | SCEN | — | EV2-0461 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.6 | A signing bonus in an Offer Sheet may not exceed 10% of total Compensation excluding Incentive Compensation | CBA | SCEN | — | EV2-0462 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.7 | Deferred Compensation is included in Salary for the Season earned, not the Season paid | CBA | SCEN | — | EV2-0463 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.8 | Deferred Compensation generally may not exceed 25% of the Compensation earned for that Season | CBA | SCEN | — | EV2-0464 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.9 | The Excluded International Player Payment Amount is $825,000 in 2023-24 and rises by $25,000 each year through $975,000 in 2029-30 | CBA | SCEN | — | EV2-0465 | new (DR2-0119) | Complete signed seven-season value table. |
| CBA2-C23.10 | The Excluded International Player Payment Amount may not be used more than once in any three-Salary-Cap-Year period for the same player | CBA | SCEN | — | EV2-0466 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.11 | Any international-player payment above the scheduled excluded amount is treated as a signing bonus and Salary | CBA | SCEN | — | EV2-0467 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.12 | A Team may not use an international-player payment to induce a Two-Way or Exhibit 10 Contract, and an agreement to make one bars those Contracts with that player for one year | CBA | SCEN | — | EV2-0468 | new (DR2-0119) | One transaction-path prohibition and its express one-year consequence. |
| CBA2-C23.13 | A below-target player loan imputes Salary at Prime Rate plus one percent minus the actual rate, with the Target Rate floored at 7% and capped at 9% | CBA | SCEN | — | EV2-0469 | new (DR2-0119) | Complete imputed-interest formula. |
| CBA2-C23.14 | A Team loan and all other outstanding Team loans to a player may not exceed his current-year Salary protected for lack of skill | CBA | SCEN | — | EV2-0470 | new (DR2-0119) | Loan-amount ceiling only. |
| CBA2-C23.15 | Reimbursement of qualifying disability-insurance premiums is excluded from Salary only under the signed policy and payment conditions | CBA | SCEN | — | EV2-0471 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.16 | Incentive compliance requires the total and unlikely ceilings plus the Extension and Renegotiation provisos | INFERRED | SCEN | — | EV2-0472 | XW2-0341, XW2-0344 | Aggregate inference; direct owners control. |
| CBA2-C23.17 | Special-compensation compliance requires signing-bonus, deferral, international-player payment, loan, and premium rules | INFERRED | SCEN | — | EV2-0473 | XW2-0342, XW2-0343, XW2-0345, XW2-0346 | Aggregate inference; direct owners control. |
| CBA2-C24.1 | A Team or Player Option may cover exactly one Season | CBA | SCEN | — | EV2-0474 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C24.2 | A Contract may contain no more than one Team Option and no more than one Player Option | CBA | SCEN | — | EV2-0475 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C24.3 | A Team or Player Option may not be conditional | CBA | SCEN | — | EV2-0476 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C24.4 | An Option Season may not reduce Salary, Likely Bonuses, or Unlikely Bonuses from the preceding Season | CBA | SCEN | — | EV2-0477 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C24.5 | An Option Season otherwise carries the preceding Season’s terms and protection | CBA | SCEN | — | EV2-0478 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C24.6 | A Second Round Pick Exception Team Option may use the separate compensation schedule permitted by that exception | CBA | SCEN | — | EV2-0479 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C24.7 | A Player Option must select one of the signed pre-exercise protection structures, including protection attaching only after the last game | CBA | SCEN | — | EV2-0480 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C24.8 | The ordinary Option and ETO deadline is June 29 at 5 p.m. Eastern unless the Contract validly states an earlier date | CBA | SCEN | — | EV2-0481 | XW2-0349 | One independently judgeable source result. |
| CBA2-C24.9 | An Option whose decline would make the player a Restricted Free Agent must be exercised before June 25 | CBA | SCEN | — | EV2-0482 | XW2-0347, XW2-0350 | One independently judgeable source result. |
| CBA2-C24.10 | An Early Termination Option may not become effective before the end of the fourth Contract Season | CBA | SCEN | — | EV2-0483 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C24.11 | A Contract may contain no more than one Early Termination Option | CBA | SCEN | — | EV2-0484 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C24.12 | An Early Termination Option may not be conditional | CBA | SCEN | — | EV2-0485 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C24.13 | Exercise of an ETO bars a later Veteran Extension, and an applicable Veteran Extension must eliminate the existing ETO | CBA | SCEN | — | EV2-0486 | XW2-0352 | One independently judgeable source result. |
| CBA2-C24.14 | A Rookie Scale Extension may add an ETO effective at the end of the fourth extended Season under the signed conditions | CBA | SCEN | — | EV2-0487 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C24.15 | Exercise or non-exercise of an Option or ETO requires the written notices specified by the CBA | CBA | SCEN | — | EV2-0488 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C24.16 | Option compliance requires one-Season shape, count, unconditionality, compensation, unchanged terms, protection, carveout, and deadlines | INFERRED | SCEN | — | EV2-0489 | XW2-0294, XW2-0348, XW2-0353 | Aggregate inference; direct owners control. |
| CBA2-C24.17 | ETO compliance requires the fourth-Season floor, count, unconditionality, deadline, notice, and extension interactions | INFERRED | SCEN | — | EV2-0490 | XW2-0351 | Aggregate inference; direct owners control. |
| CBA2-C25.1 | Team Salary includes amounts paid or payable under the Player Contract of a retired player | CBA | SCEN | — | EV2-0491 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C25.2 | On retirement, unearned protected Compensation is attributed among remaining Salary Cap Years under the signed rule | CBA | SCEN | — | EV2-0492 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C25.3 | Team Salary includes consideration or value imputed because an arrangement is found to circumvent the CBA | CBA | SCEN | EXTS | EV2-0493 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C25.4 | Team Salary includes anticipated Salary under a reported pending Contract or amendment, subject to physical and assignment conditions | CBA | SCEN | — | EV2-0494 | XW2-0355 | One independently judgeable source result. |
| CBA2-C25.5 | Only the pending amount above the otherwise applicable Free Agent Amount is added | CBA | SCEN | — | EV2-0495 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C25.6 | Fifty percent of disputed current or future grievance Salary is included while the grievance is pending | CBA | SCEN | — | EV2-0496 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C25.7 | A grievance resolved in its related Salary Cap Year is reconciled to the resolution amount in that year | CBA | SCEN | — | EV2-0497 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C25.8 | A grievance resolved later is adjusted under the signed later-year Team Salary and tax reconciliation rules | CBA | SCEN | — | EV2-0498 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C25.9 | A multi-Season grievance award is attributed pro rata unless the arbitrator specifies another allocation | CBA | SCEN | EXTS | EV2-0499 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C25.10 | Teams must promptly disclose grievance resolutions and related payments to the NBA and Players Association | CBA | SCEN | — | EV2-0500 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C25.11 | A delayed grievance resolution may be recharacterized when the delay is found to be circumvention | CBA | SCEN | EXTS | EV2-0501 | new (DR2-0119) | One independently judgeable source result. |

| CBA2-C19.20 | A Rest-of-Season Contract may also cover future Seasons subject to the applicable Article IX maximum term because Article II §10 supplies no shorter express term | INFERRED | SCEN | — | EV2-0502 | new (DR2-0119) | Aggregate inference; direct owners control. |
| CBA2-C20.29 | A Two-Way Advance requires partial lack-of-skill and injury-or-illness protection at signing, payment before November 1, and a limit of 50% of the signing-time protected Base Compensation | CBA | SCEN | — | EV2-0503 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.30 | A Two-Way Advance must be deducted first from the November 1 Base Compensation installment and then from later installments as necessary | CBA | SCEN | — | EV2-0504 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C20.31 | Two-Way protection may conditionally increase to 50% of Base Compensation if the Team does not request waivers by the negotiated date on or after the first Regular Season day | CBA | SCEN | — | EV2-0505 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.25 | An Exhibit 9 Contract must cover exactly one Season | CBA | SCEN | — | EV2-0506 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.26 | An Exhibit 9 Contract must provide the applicable Minimum Player Salary or Two-Way Player Salary | CBA | SCEN | — | EV2-0507 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.27 | An Exhibit 9 Contract may not include a bonus | CBA | SCEN | — | EV2-0508 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.28 | An Exhibit 9 Contract may not include Compensation Protection other than its governed injury termination protection | CBA | SCEN | — | EV2-0509 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.29 | Exhibit 10 bonus eligibility generally requires the player to be waived before the first Regular Season day | CBA | SCEN | — | EV2-0510 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.30 | The waiving Team must designate the player for its NBA G League affiliate under the signed Exhibit 10 process | CBA | SCEN | — | EV2-0511 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.31 | The designated player must timely report to the NBA G League affiliate to begin qualifying Exhibit 10 service | CBA | SCEN | — | EV2-0512 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.32 | Exhibit 10 conversion rescinds the player’s Exhibit 10 bonus right | CBA | SCEN | — | EV2-0513 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C21.33 | Exhibit 10 conversion creates Base Compensation protection for lack of skill and injury or illness at the Conversion Protection Amount | CBA | SCEN | — | EV2-0514 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C22.12 | The ordinary annual Salary and bonus increase or decrease limit is five percent of first-year Regular Salary | CBA | SCEN | — | EV2-0515 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C22.13 | The signed Prior-Team and Extension routes may use an eight-percent annual increase or decrease limit | CBA | SCEN | — | EV2-0516 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C22.14 | Annual-change limits are measured from first-year Regular Salary rather than compounded from each preceding Season | CBA | SCEN | — | EV2-0517 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.18 | A qualifying international-player release payment up to the year’s Excluded International Player Payment Amount is not Salary | CBA | SCEN | — | EV2-0518 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.19 | A governed international-player payment may be paid in one or multiple installments | CBA | SCEN | — | EV2-0519 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.20 | Excluded International Player Payment Amount use occurs on the Contract date regardless of payment date, and a signing-time installment schedule is not multiple use | CBA | SCEN | — | EV2-0520 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.21 | No payment governed by the international-player rule counts toward Minimum Team Salary | CBA | SCEN | — | EV2-0521 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.22 | The NBA must notify the Players Association in writing within two business days after receiving notice of a governed international-player payment | CBA | SCEN | — | EV2-0522 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.23 | When a loan is made after some fully protected Current Base Compensation for the Season has been paid, its maximum is reduced by the resulting shortfall in the maximum annual allocable repayment amount | CBA | SCEN | — | EV2-0523 | new (DR2-0119) | Loan-timing reduction only; the aggregate ceiling remains CBA2-C23.14. |
| CBA2-C23.24 | A Team loan must be repaid in equal annual amounts through deductions from remaining fully protected Current Base Compensation before any ETO Season | CBA | SCEN | — | EV2-0524 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.25 | A Team may not make a player loan that violates Article II §13(e) or when the Contract’s Base Compensation equals the Minimum Player Salary | CBA | SCEN | — | EV2-0525 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C23.26 | Team forgiveness of a player loan is deemed a Renegotiation in the Salary Cap Year of forgiveness | CBA | SCEN | — | EV2-0526 | new (DR2-0119) | One independently judgeable source result. |
| CBA2-C25.12 | Retired-player and circumvention Team Salary compliance requires Contract amounts, retirement allocation, and any adjudicated imputed value to be applied independently | INFERRED | SCEN | — | EV2-0527 | XW2-0354 | Aggregate inference; direct owners control. |
| CBA2-C25.13 | Grievance Team Salary compliance requires pending inclusion, same- or later-year reconciliation, multi-Season allocation, disclosure, and circumvention treatment | INFERRED | SCEN | — | EV2-0528 | XW2-0356 | Aggregate inference; direct owners control. |
| CBA2-C23.27 | Prime Rate for player-loan imputed interest is the prime rate reported in The Wall Street Journal’s Money Rates column or its successor | CBA | SCEN | — | EV2-0529 | new (DR2-0119) | Rate-source definition only. |
...
| CBA2-C14.1 | pending R7 | CBA2-C14.2, CBA2-C14.3, CBA2-C14.4 | Service history; team-change history | DR2-0117, DR2-0118 |
| CBA2-C14.2 | pending R7 | — | Prior Team; three-season service and transaction history | DR2-0117, DR2-0119 |
| CBA2-C14.3 | pending R7 | — | Prior Team; two-season service and transaction history | DR2-0117, DR2-0119 |
| CBA2-C14.4 | pending R7 | — | Veteran Free Agent status | DR2-0117, DR2-0119 |
| CBA2-C14.5 | pending R7 | — | Renunciation; signing route | DR2-0117, DR2-0118 |
| CBA2-C14.6 | pending R7 | — | Contract end; July 1 | DR2-0117, DR2-0119 |
| CBA2-C14.7 | pending R7 | — | RFA state | DR2-0117, DR2-0119 |
| CBA2-C14.8 | pending R7 | CBA2-C14.2, CBA2-C14.3, CBA2-C14.4 | Renunciation; later signing; service history | DR2-0117, DR2-0119 |
| CBA2-C14.9 | pending R7 | — | Early Qualifying status; written election | DR2-0117, DR2-0118 |
| CBA2-C14.10 | pending R7 | — | Qualifying status; applicable maximum | DR2-0117, DR2-0119 |
| CBA2-C14.11 | pending R7 | — | Contract term | DR2-0117, DR2-0119 |
| CBA2-C14.12 | pending R7 | — | First-year Regular Salary; later amounts | DR2-0117, DR2-0119 |
| CBA2-C14.13 | pending R7 | — | Prior amounts; EAPS; maximum | DR2-0117, DR2-0119 |
| CBA2-C14.14 | pending R7 | — | Contract term; Option Year | DR2-0117, DR2-0119 |
| CBA2-C14.15 | pending R7 | — | First-year Regular Salary; later amounts | DR2-0117, DR2-0119 |
| CBA2-C14.16 | pending R7 | — | Prior amounts; minimum; Qualifying Offer; maximum | DR2-0117, DR2-0119 |
| CBA2-C14.17 | pending R7 | — | Contract term | DR2-0117, DR2-0119 |
| CBA2-C14.18 | pending R7 | — | First-year Regular Salary; later amounts | DR2-0117, DR2-0119 |
| CBA2-C14.19 | pending R7 | — | Contract term; projected Bird status; consent | DR2-0117, DR2-0119 |
| CBA2-C14.20 | pending R7 | — | Trade; option exercise; assignee | DR2-0117, DR2-0119 |
| CBA2-C14.21 | pending R7 | — | Signing waiver; trade sequence; consent | DR2-0117, DR2-0119 |
| CBA2-C14.22 | pending R7 | CBA2-C14.10, CBA2-C14.13, CBA2-C14.16 | Bird classification; first-year compensation | DR2-0117, DR2-0118 |
| CBA2-C14.23 | pending R7 | CBA2-C14.11, CBA2-C14.12, CBA2-C14.14, CBA2-C14.15, CBA2-C14.17, CBA2-C14.18 | Bird classification; term; annual amounts | DR2-0117, DR2-0118 |
| CBA2-C14.24 | pending R7 | CBA2-C14.19, CBA2-C14.20, CBA2-C14.21 | One-season Contract; trade; consent; option | DR2-0117, DR2-0118 |
| CBA2-C15.1 | pending R7 | — | Offer Sheet; offering Team Room; match period | DR2-0117, DR2-0118 |
| CBA2-C15.2 | pending R7 | — | Offer Sheet; ROFR Team authority | DR2-0117, DR2-0119 |
| CBA2-C15.3 | pending R7 | — | YOS; first-year amounts; NTMLE | DR2-0117, DR2-0119 |
| CBA2-C15.4 | pending R7 | — | First-year Regular Salary; second-year amounts | DR2-0117, DR2-0119 |
| CBA2-C15.5 | pending R7 | — | First-two-year schedule; offering Team maximum | DR2-0117, DR2-0119 |
| CBA2-C15.6 | pending R7 | — | Third-year Regular Salary; fourth-year amount | DR2-0117, DR2-0119 |
| CBA2-C15.7 | pending R7 | — | Third/fourth-year bonuses and protection | DR2-0117, DR2-0119 |
| CBA2-C15.8 | pending R7 | — | Offering Team Room; total compensation; match result | DR2-0117, DR2-0119 |
| CBA2-C15.9 | pending R7 | — | ROFR Team; match; annual schedule | DR2-0117, DR2-0119 |
| CBA2-C15.10 | pending R7 | — | ROFR Team cap position; election | DR2-0117, DR2-0119 |
| CBA2-C15.11 | pending R7 | — | Exercise Notice date; election | DR2-0117, DR2-0119 |
| CBA2-C15.12 | pending R7 | CBA2-C15.1, CBA2-C15.2, CBA2-C15.3, CBA2-C15.4, CBA2-C15.5, CBA2-C15.6, CBA2-C15.7, CBA2-C15.8, CBA2-C15.9, CBA2-C15.10, CBA2-C15.11 | YOS; schedule; Room; match and election | DR2-0117, DR2-0118 |
| CBA2-C16.1 | pending R7 | — | Draft slot; Contract term | DR2-0117, DR2-0119 |
| CBA2-C16.2 | pending R7 | — | Draft slot; scale amount; minimum | DR2-0117, DR2-0118 |
| CBA2-C16.3 | pending R7 | — | Signing date; remaining days | DR2-0117, DR2-0119 |
| CBA2-C16.4 | pending R7 | — | Option Season; calendar | DR2-0117, DR2-0118 |
| CBA2-C16.5 | pending R7 | — | Notice recipients and date | DR2-0117, DR2-0119 |
| CBA2-C16.6 | pending R7 | — | Option decision; Season end | DR2-0117, DR2-0119 |
| CBA2-C16.7 | pending R7 | — | Prior Team; declined amount; new offer | DR2-0117, DR2-0119 |
| CBA2-C16.8 | pending R7 | — | Option terms and protection | DR2-0117, DR2-0119 |
| CBA2-C16.9 | pending R7 | — | Bonus; loan; international-player status | DR2-0117, DR2-0119 |
| CBA2-C16.10 | pending R7 | — | First-Season Salary and Unlikely Bonuses | DR2-0117, DR2-0119 |
| CBA2-C16.11 | pending R7 | — | YOS; Salary Cap; prior Salary | DR2-0117, DR2-0119 |
| CBA2-C16.12 | pending R7 | — | YOS; Salary Cap; prior Salary | DR2-0117, DR2-0119 |
| CBA2-C16.13 | pending R7 | — | YOS; Salary Cap; prior Salary | DR2-0117, DR2-0119 |
| CBA2-C16.14 | pending R7 | — | Awards; award seasons | DR2-0117, DR2-0119 |
| CBA2-C16.15 | pending R7 | — | Games; minutes; injury; eligibility determination | DR2-0117, DR2-0119 |
| CBA2-C16.16 | pending R7 | — | Team history; QVFA; YOS | DR2-0117, DR2-0119 |
| CBA2-C16.17 | pending R7 | — | Eligibility; agreed percentage; Salary Cap | DR2-0117, DR2-0119 |
| CBA2-C16.18 | pending R7 | — | Option exercise state | DR2-0117, DR2-0119 |
| CBA2-C16.19 | pending R7 | — | Moratorium end; fourth-Season schedule; signing time | DR2-0117, DR2-0119 |
| CBA2-C16.20 | pending R7 | — | Extended first Season; maximum | DR2-0117, DR2-0119 |
| CBA2-C16.21 | pending R7 | — | Extension language; award result; Salary Cap | DR2-0117, DR2-0119 |
| CBA2-C16.22 | pending R7 | — | Extension term; annual amounts | DR2-0117, DR2-0119 |
| CBA2-C16.23 | pending R7 | — | Original term; anniversary | DR2-0117, DR2-0119 |
| CBA2-C16.24 | pending R7 | — | Remaining Seasons; calendar | DR2-0117, DR2-0119 |
| CBA2-C16.25 | pending R7 | — | Final Regular Salary; EAPS; maximum | DR2-0117, DR2-0119 |
| CBA2-C16.26 | pending R7 | — | Final bonuses; first extended Season | DR2-0117, DR2-0119 |
| CBA2-C16.27 | pending R7 | — | Added Seasons; annual amounts | DR2-0117, DR2-0119 |
| CBA2-C16.28 | pending R7 | — | Team history; YOS; QVFA | DR2-0117, DR2-0119 |
| CBA2-C16.29 | pending R7 | — | Awards; award seasons | DR2-0117, DR2-0119 |
| CBA2-C16.30 | pending R7 | — | Term; agreed percentage; Salary Cap | DR2-0117, DR2-0119 |
| CBA2-C16.31 | pending R7 | — | Extension signing date; trade date | DR2-0117, DR2-0119 |
| CBA2-C16.32 | pending R7 | — | Extension compensation | DR2-0117, DR2-0118 |
| CBA2-C16.33 | pending R7 | — | Draft result; signing date; available mechanism | DR2-0117, DR2-0118 |
| CBA2-C16.34 | pending R7 | CBA2-C16.1, CBA2-C16.2, CBA2-C16.3, CBA2-C16.4, CBA2-C16.5, CBA2-C16.6, CBA2-C16.7, CBA2-C16.8, CBA2-C16.9 | Draft slot; Contract; options; compensation | DR2-0117, DR2-0118 |
| CBA2-C16.35 | pending R7 | CBA2-C16.10, CBA2-C16.11, CBA2-C16.12, CBA2-C16.13, CBA2-C16.14, CBA2-C16.15, CBA2-C16.16, CBA2-C16.17 | YOS; prior Salary; Cap; awards | DR2-0117, DR2-0118 |
| CBA2-C16.36 | pending R7 | CBA2-C16.18, CBA2-C16.19, CBA2-C16.20, CBA2-C16.21, CBA2-C16.22 | Options; signing date; awards; compensation | DR2-0117, DR2-0118 |
| CBA2-C16.37 | pending R7 | CBA2-C16.23, CBA2-C16.24, CBA2-C16.25, CBA2-C16.26, CBA2-C16.27, CBA2-C16.28, CBA2-C16.29, CBA2-C16.30, CBA2-C16.31, CBA2-C16.32 | Contract and team history; YOS; awards; compensation | DR2-0117, DR2-0118 |
| CBA2-C17.1 | pending R7 | — | Transaction type; term; DOB | DR2-0117, DR2-0118 |
| CBA2-C17.2 | pending R7 | — | DOB; covered Season | DR2-0117, DR2-0119 |
| CBA2-C17.3 | pending R7 | — | Signing date; birthday; June 30 | DR2-0117, DR2-0118 |
| CBA2-C17.4 | pending R7 | — | Term; age by Season | DR2-0117, DR2-0118 |
| CBA2-C17.5 | pending R7 | — | Annual Salary; zero and non-zero Seasons | DR2-0117, DR2-0118 |
| CBA2-C17.6 | pending R7 | — | Age; QVFA; Prior Team; term | DR2-0117, DR2-0119 |
| CBA2-C17.7 | pending R7 | — | Sign-and-Trade status | DR2-0117, DR2-0119 |
| CBA2-C17.8 | pending R7 | — | First zero Season; July 1; active state | DR2-0117, DR2-0118 |
| CBA2-C17.9 | pending R7 | CBA2-C17.1, CBA2-C17.2, CBA2-C17.3, CBA2-C17.4, CBA2-C17.5, CBA2-C17.6, CBA2-C17.7, CBA2-C17.8 | DOB; route; term; Salary; July 1 | DR2-0117, DR2-0118 |
| CBA2-C18.1 | pending R7 | — | Bonus; annual Base Compensation; protection | DR2-0117, DR2-0119 |
| CBA2-C18.2 | pending R7 | — | ETO Season; bonus | DR2-0117, DR2-0119 |
| CBA2-C18.3 | pending R7 | — | Protection by Season; first year | DR2-0117, DR2-0119 |
| CBA2-C18.4 | pending R7 | — | Trade date; remaining years; protection | DR2-0117, DR2-0119 |
| CBA2-C18.5 | pending R7 | — | Team Salary; payment date; extended protection | DR2-0117, DR2-0119 |
| CBA2-C18.6 | pending R7 | — | Extended protection; first extended year | DR2-0117, DR2-0119 |
| CBA2-C18.7 | pending R7 | — | Team Salary; payment date; extended protection | DR2-0117, DR2-0119 |
| CBA2-C18.8 | pending R7 | — | Payment date; combined-term protection | DR2-0117, DR2-0119 |
| CBA2-C18.9 | pending R7 | — | Team Salary; early payment | DR2-0117, DR2-0119 |
| CBA2-C18.10 | pending R7 | — | Bonus amount; payment dates | DR2-0117, DR2-0119 |
| CBA2-C18.11 | pending R7 | — | Trade bonus; original term; Extension | DR2-0117, DR2-0119 |
| CBA2-C18.12 | pending R7 | — | Trade bonus; Extension; maximum adjustment | DR2-0117, DR2-0119 |
| CBA2-C18.13 | pending R7 | CBA2-C18.1, CBA2-C18.2, CBA2-C18.3, CBA2-C18.4 | Bonus type; earning date; protection; ETO | DR2-0117, DR2-0118 |

| CBA2-C19.1 | pending R7 | — | Signing date | DR2-0117, DR2-0119 |
| CBA2-C19.2 | pending R7 | — | Start date; team schedule | DR2-0117, DR2-0119 |
| CBA2-C19.3 | pending R7 | — | YOS; term; minimum | DR2-0117, DR2-0119 |
| CBA2-C19.4 | pending R7 | — | Team; player; Season; prior count | DR2-0117, DR2-0119 |
| CBA2-C19.5 | pending R7 | — | Standard roster size | DR2-0117, DR2-0118 |
| CBA2-C19.6 | pending R7 | — | Hardship authorization; signing date | DR2-0117, DR2-0119 |
| CBA2-C19.7 | pending R7 | — | Hardship authorization; term | DR2-0117, DR2-0119 |
| CBA2-C19.8 | pending R7 | — | Start date; schedule; expiry | DR2-0117, DR2-0119 |
| CBA2-C19.9 | pending R7 | — | Written notice; termination time | DR2-0117, DR2-0118 |
| CBA2-C19.10 | pending R7 | — | Termination date; accrued amounts | DR2-0117, DR2-0119 |
| CBA2-C19.11 | pending R7 | — | Original expiry; proposed signing date | DR2-0117, DR2-0119 |
| CBA2-C19.12 | pending R7 | — | Ten-Day expiry; successor agreement | DR2-0117, DR2-0119 |
| CBA2-C19.13 | pending R7 | — | Calendar; signing date | DR2-0117, DR2-0119 |
| CBA2-C19.14 | pending R7 | — | YOS; remaining days | DR2-0117, DR2-0119 |
| CBA2-C19.15 | pending R7 | — | Contract type | DR2-0117, DR2-0119 |
| CBA2-C19.16 | pending R7 | — | Full-season amount; remaining and total days | DR2-0117, DR2-0119 |
| CBA2-C19.17 | pending R7 | CBA2-C19.16 | Prorated Salary; consuming rule | DR2-0117, DR2-0118 |
| CBA2-C19.18 | pending R7 | CBA2-C19.1, CBA2-C19.2, CBA2-C19.3, CBA2-C19.4, CBA2-C19.5, CBA2-C19.6, CBA2-C19.7, CBA2-C19.8, CBA2-C19.9, CBA2-C19.10, CBA2-C19.11, CBA2-C19.12 | Signing; schedule; roster; hardship; termination | DR2-0117, DR2-0118 |
| CBA2-C19.19 | pending R7 | CBA2-C19.13, CBA2-C19.14, CBA2-C19.15, CBA2-C19.16, CBA2-C19.17, CBA2-C19.20 | Signing; type; YOS; remaining days; future term | DR2-0117, DR2-0118 |
| CBA2-C20.1 | pending R7 | — | Two-Way roster count | DR2-0117, DR2-0119 |
| CBA2-C20.2 | pending R7 | — | Standard and Two-Way roster lists | DR2-0117, DR2-0119 |
| CBA2-C20.3 | pending R7 | — | Contract type; Team Salary | DR2-0117, DR2-0119 |
| CBA2-C20.4 | pending R7 | — | Zero-YOS minimum | DR2-0117, DR2-0119 |
| CBA2-C20.5 | pending R7 | — | Signing date; remaining days | DR2-0117, DR2-0119 |
| CBA2-C20.6 | pending R7 | — | Contract compensation | DR2-0117, DR2-0119 |
| CBA2-C20.7 | pending R7 | — | Contract compensation | DR2-0117, DR2-0119 |
| CBA2-C20.8 | pending R7 | — | Contract compensation | DR2-0117, DR2-0119 |
| CBA2-C20.9 | pending R7 | — | Contract compensation | DR2-0117, DR2-0119 |
| CBA2-C20.10 | pending R7 | CBA2-C20.29, CBA2-C20.30 | Advance; protection; payment schedule | DR2-0117, DR2-0119 |
| CBA2-C20.11 | pending R7 | — | Contract term | DR2-0117, DR2-0119 |
| CBA2-C20.12 | pending R7 | — | Contract terms | DR2-0117, DR2-0119 |
| CBA2-C20.13 | pending R7 | — | Contract terms | DR2-0117, DR2-0119 |
| CBA2-C20.14 | pending R7 | — | YOS at signing | DR2-0117, DR2-0118 |
| CBA2-C20.15 | pending R7 | — | YOS; prior history; term | DR2-0117, DR2-0119 |
| CBA2-C20.16 | pending R7 | — | Team; Salary Cap Years | DR2-0117, DR2-0118 |
| CBA2-C20.17 | pending R7 | — | Signing date; Season | DR2-0117, DR2-0119, DR2-0121 |
| CBA2-C20.18 | pending R7 | — | Conversion date; schedule | DR2-0117, DR2-0118 |
| CBA2-C20.19 | pending R7 | — | Conversion; YOS; minimum | DR2-0117, DR2-0119 |
| CBA2-C20.20 | pending R7 | — | Two-Way term; conversion; compensation | DR2-0117, DR2-0119 |
| CBA2-C20.21 | pending R7 | — | Room; exception; proposed Contract | DR2-0117, DR2-0119 |
| CBA2-C20.22 | pending R7 | — | New Standard; prior Two-Way | DR2-0117, DR2-0119 |
| CBA2-C20.23 | pending R7 | — | Games; signing date; Season length | DR2-0117, DR2-0119 |
| CBA2-C20.24 | pending R7 | — | Standard roster; Two-Way games | DR2-0117, DR2-0119 |
| CBA2-C20.25 | pending R7 | — | Signing date; limits; remaining Base | DR2-0117, DR2-0119 |
| CBA2-C20.26 | pending R7 | — | Protection; assignment/termination; affiliate | DR2-0117, DR2-0119 |
| CBA2-C20.27 | pending R7 | — | Contract status; ending event | DR2-0117, DR2-0119 |
| CBA2-C20.28 | pending R7 | CBA2-C20.1, CBA2-C20.2, CBA2-C20.3, CBA2-C20.4, CBA2-C20.5, CBA2-C20.6, CBA2-C20.7, CBA2-C20.8, CBA2-C20.9, CBA2-C20.10, CBA2-C20.11, CBA2-C20.12, CBA2-C20.13, CBA2-C20.14, CBA2-C20.15, CBA2-C20.16, CBA2-C20.17, CBA2-C20.18, CBA2-C20.19, CBA2-C20.20, CBA2-C20.21, CBA2-C20.22, CBA2-C20.23, CBA2-C20.24, CBA2-C20.25, CBA2-C20.26, CBA2-C20.27 | Player history; roster; Contract; dates; usage | DR2-0117, DR2-0118 |
| CBA2-C21.1 | pending R7 | CBA2-C21.25, CBA2-C21.26, CBA2-C21.27, CBA2-C21.28 | Term; salary; bonus; protection | DR2-0117, DR2-0119 |
| CBA2-C21.2 | pending R7 | — | Other Standard Contracts | DR2-0117, DR2-0119 |
| CBA2-C21.3 | pending R7 | — | Exhibit 9 count | DR2-0117, DR2-0119 |
| CBA2-C21.4 | pending R7 | — | Eligibility; injury; indexed amount | DR2-0117, DR2-0119 |
| CBA2-C21.5 | pending R7 | — | Termination basis | DR2-0117, DR2-0119 |
| CBA2-C21.6 | pending R7 | — | Term and salary | DR2-0117, DR2-0119 |
| CBA2-C21.7 | pending R7 | — | Contract compensation | DR2-0117, DR2-0119 |
| CBA2-C21.8 | pending R7 | — | Exhibit 10 count | DR2-0117, DR2-0118 |
| CBA2-C21.9 | pending R7 | — | Bonus amount; indexed maximum | DR2-0117, DR2-0119 |
| CBA2-C21.10 | pending R7 | CBA2-C21.29, CBA2-C21.30, CBA2-C21.31 | Waiver; designation; reporting | DR2-0117, DR2-0119 |
| CBA2-C21.11 | pending R7 | — | Affiliate service days | DR2-0117, DR2-0119 |
| CBA2-C21.12 | pending R7 | — | Affiliate service; interruption; return | DR2-0117, DR2-0119 |
| CBA2-C21.13 | pending R7 | — | Other pro contract; affiliate service | DR2-0117, DR2-0119 |
| CBA2-C21.14 | pending R7 | — | Affiliate injury; medical proof; roster state | DR2-0117, DR2-0119 |
| CBA2-C21.15 | pending R7 | — | Conversion date; eligibility | DR2-0117, DR2-0119 |
| CBA2-C21.16 | pending R7 | CBA2-C21.32, CBA2-C21.33 | Conversion; bonus; protection | DR2-0117, DR2-0118 |
| CBA2-C21.17 | pending R7 | — | Bonus; conversion protection | DR2-0117, DR2-0118 |
| CBA2-C21.18 | pending R7 | — | Assignment; converted protection; acquiring Team | DR2-0117, DR2-0118 |
| CBA2-C21.19 | pending R7 | — | Bonus; Team Salary | DR2-0117, DR2-0119 |
| CBA2-C21.20 | pending R7 | — | Designation; returning rights; notice | DR2-0117, DR2-0119 |
| CBA2-C21.21 | pending R7 | — | Summer Contract; calendar | DR2-0117, DR2-0118 |
| CBA2-C21.22 | pending R7 | — | Contract status; Room; exception; deadline | DR2-0117, DR2-0118 |
| CBA2-C21.23 | pending R7 | CBA2-C21.1, CBA2-C21.2, CBA2-C21.3, CBA2-C21.4, CBA2-C21.5 | Roster; Contract; injury; termination | DR2-0117, DR2-0118 |
| CBA2-C21.24 | pending R7 | CBA2-C21.6, CBA2-C21.7, CBA2-C21.8, CBA2-C21.9, CBA2-C21.10, CBA2-C21.11, CBA2-C21.12, CBA2-C21.13, CBA2-C21.14, CBA2-C21.15, CBA2-C21.16, CBA2-C21.17, CBA2-C21.18, CBA2-C21.19, CBA2-C21.20 | Contract; count; waiver; service; conversion; assignment | DR2-0117, DR2-0118 |

| CBA2-C22.1 | pending R7 | — | Protection by Season | DR2-0117, DR2-0119 |
| CBA2-C22.2 | pending R7 | — | Protection condition; completion date | DR2-0117, DR2-0119 |
| CBA2-C22.3 | pending R7 | — | Salary level; bonus | DR2-0117, DR2-0119 |
| CBA2-C22.4 | pending R7 | — | Bonus type; international status | DR2-0117, DR2-0118 |
| CBA2-C22.5 | pending R7 | — | July 1; actual Cap; percentage clause | DR2-0117, DR2-0119 |
| CBA2-C22.6 | pending R7 | — | Adjusted maximum; signing allocation | DR2-0117, DR2-0119 |
| CBA2-C22.7 | pending R7 | — | Remaining excess; bonuses | DR2-0117, DR2-0119 |
| CBA2-C22.8 | pending R7 | — | Remaining excess; Base; later amounts | DR2-0117, DR2-0119 |
| CBA2-C22.9 | pending R7 | CBA2-C22.12, CBA2-C22.13, CBA2-C22.14 | Signing route; first-year Regular Salary; annual amounts | DR2-0117, DR2-0119 |
| CBA2-C22.10 | pending R7 | — | Transaction type; annual amounts | DR2-0117, DR2-0119 |
| CBA2-C22.11 | pending R7 | CBA2-C22.1, CBA2-C22.2, CBA2-C22.3, CBA2-C22.4, CBA2-C22.5, CBA2-C22.6, CBA2-C22.7, CBA2-C22.8, CBA2-C22.9, CBA2-C22.10 | Protection; salary type; July 1; annual amounts | DR2-0117, DR2-0118 |
| CBA2-C23.1 | pending R7 | — | Regular Salary; total incentives | DR2-0117, DR2-0119 |
| CBA2-C23.2 | pending R7 | — | Regular Salary; Unlikely Bonuses | DR2-0117, DR2-0119 |
| CBA2-C23.3 | pending R7 | — | Original and extended bonuses; extension | DR2-0117, DR2-0119 |
| CBA2-C23.4 | pending R7 | — | Renegotiation; Regular Salary; bonuses | DR2-0117, DR2-0119 |
| CBA2-C23.5 | pending R7 | — | Signing bonus; non-incentive Compensation | DR2-0117, DR2-0119 |
| CBA2-C23.6 | pending R7 | — | Offer Sheet; bonus; Compensation | DR2-0117, DR2-0119 |
| CBA2-C23.7 | pending R7 | — | Earning Season; payment schedule | DR2-0117, DR2-0119 |
| CBA2-C23.8 | pending R7 | — | Season Compensation; deferred amount | DR2-0117, DR2-0119 |
| CBA2-C23.9 | pending R7 | — | Contract Season; scheduled amount | DR2-0117, DR2-0119 |
| CBA2-C23.10 | pending R7 | — | Prior use; Salary Cap Years | DR2-0117, DR2-0119 |
| CBA2-C23.11 | pending R7 | — | Scheduled amount; actual payment | DR2-0117, DR2-0119 |
| CBA2-C23.12 | pending R7 | — | International-player payment; proposed route; time | DR2-0117, DR2-0119 |
| CBA2-C23.13 | pending R7 | — | Loan principal; rates; dates | DR2-0117, DR2-0119 |
| CBA2-C23.14 | pending R7 | — | Outstanding loans; current-year Salary protected for lack of skill | DR2-0117, DR2-0119 |
| CBA2-C23.15 | pending R7 | — | Policy; premium; reimbursement | DR2-0117, DR2-0119 |
| CBA2-C23.16 | pending R7 | CBA2-C23.1, CBA2-C23.2, CBA2-C23.3, CBA2-C23.4 | Regular Salary; incentives; amendment | DR2-0117, DR2-0118 |
| CBA2-C23.17 | pending R7 | CBA2-C23.5, CBA2-C23.6, CBA2-C23.7, CBA2-C23.8, CBA2-C23.9, CBA2-C23.10, CBA2-C23.11, CBA2-C23.12, CBA2-C23.13, CBA2-C23.14, CBA2-C23.15, CBA2-C23.18, CBA2-C23.19, CBA2-C23.20, CBA2-C23.21, CBA2-C23.22, CBA2-C23.23, CBA2-C23.24, CBA2-C23.25, CBA2-C23.26, CBA2-C23.27 | Contract type; payments; loans; insurance | DR2-0117, DR2-0118 |
| CBA2-C24.1 | pending R7 | — | Option term | DR2-0117, DR2-0119 |
| CBA2-C24.2 | pending R7 | — | Contract options | DR2-0117, DR2-0119 |
| CBA2-C24.3 | pending R7 | — | Option terms | DR2-0117, DR2-0119 |
| CBA2-C24.4 | pending R7 | — | Preceding and option amounts | DR2-0117, DR2-0119 |
| CBA2-C24.5 | pending R7 | — | Preceding and option terms | DR2-0117, DR2-0119 |
| CBA2-C24.6 | pending R7 | — | SRPE Contract; Team Option amounts | DR2-0117, DR2-0119 |
| CBA2-C24.7 | pending R7 | — | Player Option; protection; last game | DR2-0117, DR2-0119 |
| CBA2-C24.8 | pending R7 | — | Contract deadline; timestamp | DR2-0117, DR2-0118 |
| CBA2-C24.9 | pending R7 | — | Projected RFA status; exercise date | DR2-0117, DR2-0118 |
| CBA2-C24.10 | pending R7 | — | Contract Seasons; ETO effective date | DR2-0117, DR2-0119 |
| CBA2-C24.11 | pending R7 | — | Contract ETOs | DR2-0117, DR2-0119 |
| CBA2-C24.12 | pending R7 | — | ETO terms | DR2-0117, DR2-0119 |
| CBA2-C24.13 | pending R7 | — | ETO exercise; extension | DR2-0117, DR2-0118 |
| CBA2-C24.14 | pending R7 | — | Rookie extension; extended term | DR2-0117, DR2-0119 |
| CBA2-C24.15 | pending R7 | — | Option or ETO; notice; deadline | DR2-0117, DR2-0119 |
| CBA2-C24.16 | pending R7 | CBA2-C24.1, CBA2-C24.2, CBA2-C24.3, CBA2-C24.4, CBA2-C24.5, CBA2-C24.6, CBA2-C24.7, CBA2-C24.8, CBA2-C24.9, CBA2-C24.15 | Option type; terms; compensation; date | DR2-0117, DR2-0118 |
| CBA2-C24.17 | pending R7 | CBA2-C24.8, CBA2-C24.10, CBA2-C24.11, CBA2-C24.12, CBA2-C24.13, CBA2-C24.14, CBA2-C24.15 | Contract term; ETO terms; date; extension | DR2-0117, DR2-0118 |
| CBA2-C25.1 | pending R7 | — | Retirement; Contract amounts | DR2-0117, DR2-0119 |
| CBA2-C25.2 | pending R7 | — | Retirement date; remaining protected Compensation | DR2-0117, DR2-0119 |
| CBA2-C25.3 | pending R7 | — | Circumvention determination; imputed amount | DR2-0117, DR2-0119 |
| CBA2-C25.4 | pending R7 | — | Reported agreement; physical; assignment | DR2-0117, DR2-0118 |
| CBA2-C25.5 | pending R7 | — | Pending Salary; Free Agent Amount | DR2-0117, DR2-0119 |
| CBA2-C25.6 | pending R7 | — | Grievance; disputed Salary; Seasons | DR2-0117, DR2-0119 |
| CBA2-C25.7 | pending R7 | — | Resolution date; related year; award | DR2-0117, DR2-0119 |
| CBA2-C25.8 | pending R7 | — | Resolution year; related year; award; tax | DR2-0117, DR2-0119 |
| CBA2-C25.9 | pending R7 | — | Award; Seasons; arbitrator allocation | DR2-0117, DR2-0119 |
| CBA2-C25.10 | pending R7 | — | Resolution; payment; notice date | DR2-0117, DR2-0119 |
| CBA2-C25.11 | pending R7 | — | Delay; circumstances; determination | DR2-0117, DR2-0119 |

| CBA2-C19.20 | pending R7 | CBA2-C19.13 | Contract term; signing date | DR2-0117, DR2-0119 |
| CBA2-C20.29 | pending R7 | — | Signing protection; payment date; Advance amount | DR2-0117, DR2-0119 |
| CBA2-C20.30 | pending R7 | — | Advance; installment schedule | DR2-0117, DR2-0119 |
| CBA2-C20.31 | pending R7 | — | Protection clause; waiver-request date | DR2-0117, DR2-0119 |
| CBA2-C21.25 | pending R7 | — | Contract term | DR2-0117, DR2-0119 |
| CBA2-C21.26 | pending R7 | — | Contract salary | DR2-0117, DR2-0119 |
| CBA2-C21.27 | pending R7 | — | Contract bonus | DR2-0117, DR2-0119 |
| CBA2-C21.28 | pending R7 | — | Contract protection | DR2-0117, DR2-0119 |
| CBA2-C21.29 | pending R7 | — | Waiver date | DR2-0117, DR2-0119 |
| CBA2-C21.30 | pending R7 | — | Waiver; affiliate designation | DR2-0117, DR2-0119 |
| CBA2-C21.31 | pending R7 | — | Designation; reporting date | DR2-0117, DR2-0119 |
| CBA2-C21.32 | pending R7 | — | Conversion; Exhibit 10 bonus | DR2-0117, DR2-0119 |
| CBA2-C21.33 | pending R7 | — | Conversion; protection amount | DR2-0117, DR2-0119 |
| CBA2-C22.12 | pending R7 | — | First-year Regular Salary; annual amounts | DR2-0117, DR2-0119 |
| CBA2-C22.13 | pending R7 | — | Signing or extension route; annual amounts | DR2-0117, DR2-0119 |
| CBA2-C22.14 | pending R7 | — | First-year Regular Salary; later amounts | DR2-0117, DR2-0119 |
| CBA2-C23.18 | pending R7 | — | Payment recipient, purpose, and amount | DR2-0117, DR2-0119 |
| CBA2-C23.19 | pending R7 | — | Payment schedule | DR2-0117, DR2-0119 |
| CBA2-C23.20 | pending R7 | — | Contract date; payment schedule | DR2-0117, DR2-0119 |
| CBA2-C23.21 | pending R7 | — | International-player payment; MTS | DR2-0117, DR2-0119 |
| CBA2-C23.22 | pending R7 | — | NBA receipt date; notice date | DR2-0117, DR2-0119 |
| CBA2-C23.23 | pending R7 | — | Loan date; remaining protected Current Base Compensation; annual repayment amount | DR2-0117, DR2-0119 |
| CBA2-C23.24 | pending R7 | — | Loan; protected Current Base Compensation; ETO | DR2-0117, DR2-0119 |
| CBA2-C23.25 | pending R7 | — | Loan; Contract compensation; Article II §13(e) | DR2-0117, DR2-0119 |
| CBA2-C23.26 | pending R7 | — | Loan forgiveness; Salary Cap Year | DR2-0117, DR2-0119 |
| CBA2-C25.12 | pending R7 | CBA2-C25.1, CBA2-C25.2, CBA2-C25.3 | Retirement; Contract amounts; circumvention determination | DR2-0117, DR2-0118 |
| CBA2-C25.13 | pending R7 | CBA2-C25.6, CBA2-C25.7, CBA2-C25.8, CBA2-C25.9, CBA2-C25.10, CBA2-C25.11 | Grievance; disputed Salary; resolution; disclosure | DR2-0117, DR2-0118 |
| CBA2-C23.27 | pending R7 | — | Journal prime-rate publication at loan agreement date | DR2-0117, DR2-0119 |
...
| XW2-0279 | CBA-C14.1 | CBA2-C14.1 | `equivalent` | [CBA-C14.1:F1] span:0-36 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0280 | CBA-C14.2 | CBA2-C14.5 | `partial-overlap` | [CBA-C14.2:F1] span:0-157 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0281 | CBA-C14.3 | CBA2-C14.9 | `equivalent` | [CBA-C14.3:F1] span:0-89 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0282 | CBA-C14.4 | CBA2-C14.22 | `equivalent` | [CBA-C14.4:F1] span:0-186 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0283 | CBA-C14.5 | CBA2-C14.23 | `equivalent` | [CBA-C14.5:F1] span:0-112 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0284 | CBA-C14.6 | CBA2-C14.1 | `partial-overlap` | [CBA-C14.6:F1] span:0-58 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0285 | CBA-C14.7 | CBA2-C14.1 | `partial-overlap` | [CBA-C14.7:F1] span:0-154 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0286 | CBA-C14.8 | CBA2-C14.24 | `merge` | [CBA-C14.8:F1] span:0-140 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0287 | CBA-C14.9 | CBA2-C14.24 | `merge` | [CBA-C14.9:F1] span:0-139 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0288 | CBA-C15.1 | CBA2-C15.1 | `equivalent` | [CBA-C15.1:F1] span:0-79 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0289 | CBA-C15.2 | CBA2-C15.12 | `equivalent` | [CBA-C15.2:F1] span:0-220 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0290 | CBA-C16.1 | CBA2-C16.34 | `equivalent` | [CBA-C16.1:F1] span:0-75 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0291 | CBA-C16.2 | CBA2-C16.2 | `equivalent` | [CBA-C16.2:F1] span:0-89 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0292 | CBA-C16.3 | CBA2-C16.4 | `equivalent` | [CBA-C16.3:F1] span:0-69 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0293 | CBA-C16.4 | CBA2-C16.34 | `partial-overlap` | [CBA-C16.4:F1] span:0-120 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0294 | CBA-C16.5 | CBA2-C24.16 | `moved` | [CBA-C16.5:F1] span:0-101 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0295 | CBA-C16.6 | CBA2-C16.35 | `equivalent` | [CBA-C16.6:F1] span:0-153 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0296 | CBA-C16.7 | CBA2-C16.35 | `equivalent` | [CBA-C16.7:F1] span:0-104 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0297 | CBA-C16.8 | CBA2-C16.36 | `equivalent` | [CBA-C16.8:F1] span:0-123 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0298 | CBA-C16.9 | CBA2-C16.36 | `equivalent` | [CBA-C16.9:F1] span:0-90 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0299 | CBA-C16.10 | CBA2-C16.36 | `partial-overlap` | [CBA-C16.10:F1] span:0-56 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0300 | CBA-C16.11 | CBA2-C16.37 | `equivalent` | [CBA-C16.11:F1] span:0-133 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0301 | CBA-C16.12 | CBA2-C16.37 | `equivalent` | [CBA-C16.12:F1] span:0-146 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0302 | CBA-C16.13 | CBA2-C16.37 | `equivalent` | [CBA-C16.13:F1] span:0-118 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0303 | CBA-C16.14 | CBA2-C16.32 | `equivalent` | [CBA-C16.14:F1] span:0-68 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0304 | CBA-C17.1 | CBA2-C17.1 | `equivalent` | [CBA-C17.1:F1] span:0-139 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0305 | CBA-C17.2 | CBA2-C17.3 | `equivalent` | [CBA-C17.2:F1] span:0-69 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0306 | CBA-C17.3 | CBA2-C17.4 | `equivalent` | [CBA-C17.3:F1] span:0-135 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0307 | CBA-C17.4 | CBA2-C17.9 | `equivalent` | [CBA-C17.4:F1] span:0-189 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0308 | CBA-C17.5 | CBA2-C17.5 | `equivalent` | [CBA-C17.5:F1] span:0-90 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0309 | CBA-C17.6 | CBA2-C17.8 | `equivalent` | [CBA-C17.6:F1] span:0-102 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0310 | CBA-C17.7 | — | `process-only` | [CBA-C17.7:F1] span:0-142 — Whole normalized historical obligation; drafting/input statement only; the actual rule is separately registered where applicable | DR2-0120 |
| XW2-0311 | CBA-C18 | CBA2-C18.13 | `partial-overlap` | [CBA-C18:F1] span:0-195 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0312 | CBA-C19.1 | CBA2-C19.18 | `equivalent` | [CBA-C19.1:F1] span:0-104 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0313 | CBA-C19.2 | CBA2-C19.5 | `partial-overlap` | [CBA-C19.2:F1] span:0-104 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0314 | CBA-C19.3 | CBA2-C19.9 | `partial-overlap` | [CBA-C19.3:F1] span:0-77 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0315 | CBA-C19.4 | CBA2-C19.19 | `partial-overlap` | [CBA-C19.4:F1] span:0-121 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0316 | CBA-C19.5 | CBA2-C19.17 | `equivalent` | [CBA-C19.5:F1] span:0-77 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0317 | CBA-C19.6 | — | `process-only` | [CBA-C19.6:F1] span:0-83 — Whole normalized historical obligation; drafting/input statement only; the actual rule is separately registered where applicable | DR2-0122 |
| XW2-0318 | CBA-C20.1 | CBA2-C20.28 | `partial-overlap` | [CBA-C20.1:F1] span:0-97 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0319 | CBA-C20.2 | CBA2-C20.14 | `partial-overlap` | [CBA-C20.2:F1] span:0-94 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0320 | CBA-C20.3 | CBA2-C20.16 | `equivalent` | [CBA-C20.3:F1] span:0-100 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0321 | CBA-C20.4 | CBA2-C20.28 | `partial-overlap` | [CBA-C20.4:F1] span:0-144 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0322 | CBA-C20.5 | CBA2-C20.28 | `partial-overlap` | [CBA-C20.5:F1] span:0-162 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0323 | CBA-C20.6 | CBA2-C20.18 | `equivalent` | [CBA-C20.6:F1] span:0-82 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0324 | CBA-C20.8 | CBA2-C16.33 | `moved` | [CBA-C20.8:F1] span:0-122 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0325 | CBA-C20.9 | — | `process-only` | [CBA-C20.9:F1] span:0-90 — Whole normalized historical obligation; drafting/input statement only; the actual rule is separately registered where applicable | DR2-0123 |
| XW2-0326 | CBA-C21.1 | CBA2-C21.23 | `merge` | [CBA-C21.1:F1] span:0-94 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0327 | CBA-C21.2 | CBA2-C21.24 | `partial-overlap` | [CBA-C21.2:F1] span:0-136 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0328 | CBA-C21.3 | CBA2-C21.8 | `equivalent` | [CBA-C21.3:F1] span:0-61 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0329 | CBA-C21.4 | CBA2-C21.16 | `equivalent` | [CBA-C21.4:F1] span:0-86 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0330 | CBA-C21.5 | CBA2-C21.17 | `equivalent` | [CBA-C21.5:F1] span:0-94 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0331 | CBA-C21.6 | CBA2-C21.24 | `partial-overlap` | [CBA-C21.6:F1] span:0-160 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0332 | CBA-C21.7 | CBA2-C21.18 | `equivalent` | [CBA-C21.7:F1] span:0-79 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0333 | CBA-C21.8 | CBA2-C21.23 | `merge` | [CBA-C21.8:F1] span:0-116 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0334 | CBA-C21.9 | CBA2-C21.21 | `moved` | [CBA-C21.9:F1] span:0-86 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0335 | CBA-C21.10 | CBA2-C21.23 | `equivalent` | [CBA-C21.10:F1] span:0-113 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0336 | CBA-C21.11 | CBA2-C21.22 | `moved` | [CBA-C21.11:F1] span:0-106 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0337 | CBA-C22.1 | CBA2-C22.11 | `equivalent` | [CBA-C22.1:F1] span:0-148 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0338 | CBA-C22.2 | CBA2-C22.4 | `equivalent` | [CBA-C22.2:F1] span:0-134 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0339 | CBA-C22.3 | CBA2-C22.11 | `equivalent` | [CBA-C22.3:F1] span:0-171 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0340 | CBA-C22.4 | CBA2-C22.11 | `equivalent` | [CBA-C22.4:F1] span:0-151 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0341 | CBA-C23.1 | CBA2-C23.16 | `merge` | [CBA-C23.1:F1] span:0-81 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0342 | CBA-C23.2 | CBA2-C23.17 | `equivalent` | [CBA-C23.2:F1] span:0-113 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0343 | CBA-C23.3 | CBA2-C23.17 | `equivalent` | [CBA-C23.3:F1] span:0-133 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0344 | CBA-C23.4 | CBA2-C23.16 | `merge` | [CBA-C23.4:F1] span:0-146 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0345 | CBA-C23.5 | CBA2-C23.17 | `equivalent` | [CBA-C23.5:F1] span:0-192 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0346 | CBA-C23.6 | CBA2-C23.17 | `equivalent` | [CBA-C23.6:F1] span:0-117 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0347 | CBA-C24.1 | CBA2-C24.9 | `merge` | [CBA-C24.1:F1] span:0-103 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0348 | CBA-C24.2 | CBA2-C24.16 | `equivalent` | [CBA-C24.2:F1] span:0-150 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0349 | CBA-C24.3 | CBA2-C24.8 | `equivalent` | [CBA-C24.3:F1] span:0-51 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0350 | CBA-C24.4 | CBA2-C24.9 | `merge` | [CBA-C24.4:F1] span:0-99 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0351 | CBA-C24.5 | CBA2-C24.17 | `equivalent` | [CBA-C24.5:F1] span:0-134 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0352 | CBA-C24.6 | CBA2-C24.13 | `equivalent` | [CBA-C24.6:F1] span:0-109 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0353 | CBA-C24.7 | CBA2-C24.16 | `partial-overlap` | [CBA-C24.7:F1] span:0-76 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0354 | CBA-C25.1 | CBA2-C25.12 | `equivalent` | [CBA-C25.1:F1] span:0-93 — Whole normalized historical obligation; retired-player and circumvention components route through the staged current owner | DR2-0118 |
| XW2-0355 | CBA-C25.2 | CBA2-C25.4 | `partial-overlap` | [CBA-C25.2:F1] span:0-62 — Whole normalized historical obligation; complete normalized historical statement routed through the named current owner and its atomic dependencies | DR2-0118 |
| XW2-0356 | CBA-C25.3 | CBA2-C25.13 | `equivalent` | [CBA-C25.3:F1] span:0-94 — Whole normalized historical obligation; pending exposure and later reconciliation route through the staged current owner | DR2-0118 |
...
| EV2-0280 | CBA2-C14.1 | INFERRED | SRC2-001 | EV2-0281, EV2-0282, EV2-0283 | CBA I §1(r), (aaa), (ggg), pp. 2–6 | The three direct definitions classify the player from exact service and team-change history | Supplies the routed Bird-status classification | Inference over the three direct definition components | Direct definition owners control |
| EV2-0281 | CBA2-C14.2 | CBA | SRC2-001 | — | CBA I §1(ggg), pp. 3–4 | Tight paraphrase: Qualifying Veteran Free Agent status requires three immediately preceding Seasons of Service with the Prior Team, subject only to the signed trade, first-season waiver-claim, and first-season signing continuity routes | Supplies the independently judgeable requirement stated by CBA2-C14.2 | — | — |
| EV2-0282 | CBA2-C14.3 | CBA | SRC2-001 | — | CBA I §1(r), pp. 2–3 | Tight paraphrase: Early Qualifying Veteran Free Agent status requires two immediately preceding Seasons of Service with the Prior Team under the signed continuity routes | Supplies the independently judgeable requirement stated by CBA2-C14.3 | — | — |
| EV2-0283 | CBA2-C14.4 | CBA | SRC2-001 | — | CBA I §1(aaa), p. 6 | Tight paraphrase: A Veteran Free Agent who is neither Qualifying nor Early Qualifying is a Non-Qualifying Veteran Free Agent | Supplies the independently judgeable requirement stated by CBA2-C14.4 | — | — |
| EV2-0284 | CBA2-C14.5 | CBA | SRC2-001 | — | CBA VII §4(g)(1), pp. 221–22 | Tight paraphrase: Renouncing a Veteran Free Agent removes his Free Agent Amount and loses the Team’s right to use the Qualifying or Early Qualifying Veteran Free Agent Exception for him | Supplies the independently judgeable requirement stated by CBA2-C14.5 | — | — |
| EV2-0285 | CBA2-C14.6 | CBA | SRC2-001 | — | CBA VII §4(g)(1), p. 221 | Tight paraphrase: A Team may not renounce a Veteran Free Agent before July 1 following the last Season of his Contract | Supplies the independently judgeable requirement stated by CBA2-C14.6 | — | — |
| EV2-0286 | CBA2-C14.7 | CBA | SRC2-001 | — | CBA VII §4(g)(1), p. 221 | Tight paraphrase: A Team may not renounce a Restricted Free Agent while he remains subject to a Right of First Refusal | Supplies the independently judgeable requirement stated by CBA2-C14.7 | — | — |
| EV2-0287 | CBA2-C14.8 | INFERRED | SRC2-001 | EV2-0281, EV2-0282, EV2-0283 | CBA I §1(r), (aaa), (ggg), pp. 2–6; VII §4(g), pp. 221–22 | Tight paraphrase: Renunciation changes the current hold and signing route but does not rewrite service and team-change history used by a later Bird classification | Supplies the independently judgeable requirement stated by CBA2-C14.8 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0288 | CBA2-C14.9 | CBA | SRC2-001 | — | CBA VII §4(d)(2), p. 220 | Tight paraphrase: A Team may elect in writing to treat an Early Qualifying Veteran Free Agent as Non-Qualifying for the new Contract | Supplies the independently judgeable requirement stated by CBA2-C14.9 | — | — |
| EV2-0289 | CBA2-C14.10 | CBA | SRC2-001 | — | CBA VII §6(b)(1), p. 231 | Tight paraphrase: A Qualifying Veteran Free Agent may receive first-year Salary plus Unlikely Bonuses up to his applicable Maximum Annual Salary | Supplies the independently judgeable requirement stated by CBA2-C14.10 | — | — |
| EV2-0290 | CBA2-C14.11 | CBA | SRC2-001 | — | CBA VII §6(b)(1), p. 231 | Tight paraphrase: A Qualifying Veteran Free Agent Contract may cover no more than five Seasons | Supplies the independently judgeable requirement stated by CBA2-C14.11 | — | — |
| EV2-0291 | CBA2-C14.12 | CBA | SRC2-001 | — | CBA VII §§5(a)(2), 6(b)(1), pp. 227–28, 231 | Tight paraphrase: A Qualifying Veteran Free Agent Contract may use annual changes up to eight percent of first-year Regular Salary | Supplies the independently judgeable requirement stated by CBA2-C14.12 | — | — |
| EV2-0292 | CBA2-C14.13 | CBA | SRC2-001 | — | CBA VII §6(b)(2), pp. 231–32 | Tight paraphrase: An Early Qualifying Veteran Free Agent’s first-year Salary plus Unlikely Bonuses may not exceed the greater of 175% of prior Regular Salary plus prior Likely Bonuses or 105% of Estimated Average Player Salary, subject to the maximum | Supplies the independently judgeable requirement stated by CBA2-C14.13 | — | — |
| EV2-0293 | CBA2-C14.14 | CBA | SRC2-001 | — | CBA VII §6(b)(2), p. 232 | Tight paraphrase: An Early Qualifying Veteran Free Agent Contract must cover at least two and no more than four Seasons, excluding an Option Year from the minimum | Supplies the independently judgeable requirement stated by CBA2-C14.14 | — | — |
| EV2-0294 | CBA2-C14.15 | CBA | SRC2-001 | — | CBA VII §§5(a)(2), 6(b)(2), pp. 227–28, 232 | Tight paraphrase: An Early Qualifying Veteran Free Agent Contract may use annual changes up to eight percent of first-year Regular Salary | Supplies the independently judgeable requirement stated by CBA2-C14.15 | — | — |
| EV2-0295 | CBA2-C14.16 | CBA | SRC2-001 | — | CBA VII §6(b)(3), p. 232 | Tight paraphrase: A Non-Qualifying Veteran Free Agent’s first-year Salary plus Unlikely Bonuses may not exceed the greatest of 120% of prior Regular Salary plus prior Likely Bonuses, 120% of the applicable Minimum Player Salary, or his Qualifying Offer, subject to the maximum | Supplies the independently judgeable requirement stated by CBA2-C14.16 | — | — |
| EV2-0296 | CBA2-C14.17 | CBA | SRC2-001 | — | CBA VII §6(b)(3), p. 232 | Tight paraphrase: A Non-Qualifying Veteran Free Agent Contract may cover no more than four Seasons | Supplies the independently judgeable requirement stated by CBA2-C14.17 | — | — |
| EV2-0297 | CBA2-C14.18 | CBA | SRC2-001 | — | CBA VII §§5(a)(1), 6(b)(3), pp. 227, 232 | Tight paraphrase: A Non-Qualifying Veteran Free Agent Contract may use annual changes up to five percent of first-year Regular Salary | Supplies the independently judgeable requirement stated by CBA2-C14.18 | — | — |
| EV2-0298 | CBA2-C14.19 | CBA | SRC2-001 | — | CBA VII §8(b)(1), pp. 260–61 | Tight paraphrase: A non-Two-Way one-season Contract that would leave the player Qualifying or Early Qualifying after the Season may not be traded without consent unless the signing-time elimination route applies | Supplies the independently judgeable requirement stated by CBA2-C14.19 | — | — |
| EV2-0299 | CBA2-C14.20 | CBA | SRC2-001 | — | CBA VII §8(b)(1), p. 261 | Tight paraphrase: After a trade under the one-season consent rule, the player is treated for Bird status as having signed with the assignee as a free agent, except after exercise of a second-season Team or Player Option | Supplies the independently judgeable requirement stated by CBA2-C14.20 | — | — |
| EV2-0300 | CBA2-C14.21 | CBA | SRC2-001 | — | CBA VII §8(b)(1), pp. 260–61 | Tight paraphrase: A one-season trade-consent right continues on later assignments unless waived at signing or by affirmative transaction consent | Supplies the independently judgeable requirement stated by CBA2-C14.21 | — | — |
| EV2-0301 | CBA2-C14.22 | INFERRED | SRC2-001 | EV2-0289, EV2-0292, EV2-0295 | CBA VII §6(b)(1)–(3), pp. 231–33 | Tight paraphrase: Bird first-year signing authority must use the independently applicable Full Bird, Early Bird, or Non-Bird ceiling | Supplies the independently judgeable requirement stated by CBA2-C14.22 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0302 | CBA2-C14.23 | INFERRED | SRC2-001 | EV2-0290, EV2-0291, EV2-0293, EV2-0294, EV2-0296, EV2-0297 | CBA VII §§5(a), 6(b), pp. 227–33 | Tight paraphrase: Bird Contract term and annual-change compliance requires the independently applicable status-specific term and raise rules | Supplies the independently judgeable requirement stated by CBA2-C14.23 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0303 | CBA2-C14.24 | INFERRED | SRC2-001 | EV2-0298, EV2-0299, EV2-0300 | CBA VII §8(b)(1), pp. 260–61 | Tight paraphrase: One-season Bird-right trade treatment requires the consent predicate, post-trade status consequence, and waiver state to be applied independently | Supplies the independently judgeable requirement stated by CBA2-C14.24 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0304 | CBA2-C15.1 | CBA | SRC2-001 | — | CBA XI §5(b)(2), pp. 323–24 | Tight paraphrase: An offering Team must preserve sufficient Room for a one- or two-YOS Veteran Free Agent Offer Sheet until it ends or is matched | Supplies the independently judgeable requirement stated by CBA2-C15.1 | — | — |
| EV2-0305 | CBA2-C15.2 | CBA | SRC2-001 | — | CBA XI §5(b)(3), p. 324 | Tight paraphrase: The ROFR Team must preserve the Room or exception authority required to match an outstanding Offer Sheet throughout the matching period | Supplies the independently judgeable requirement stated by CBA2-C15.2 | — | — |
| EV2-0306 | CBA2-C15.3 | CBA | SRC2-001 | — | CBA XI §5(d)(1), p. 325 | Tight paraphrase: A qualifying one- or two-YOS Offer Sheet’s first-year Salary plus Unlikely Bonuses may not exceed the NTMLE amount | Supplies the independently judgeable requirement stated by CBA2-C15.3 | — | — |
| EV2-0307 | CBA2-C15.4 | CBA | SRC2-001 | — | CBA XI §5(d)(i), p. 323; VII §5(a)(1), p. 227 | Annual changes are governed by §5(a)(1), whose ordinary limit is five percent of first-year Regular Salary | Supplies the second-year increase/decrease rule | — | — |
| EV2-0308 | CBA2-C15.5 | CBA | SRC2-001 | — | CBA XI §5(d)(1), pp. 325–26 | Tight paraphrase: Its third-year Salary may jump to the offering Team’s maximum only when the first two Seasons use the permitted maximum amounts | Supplies the independently judgeable requirement stated by CBA2-C15.5 | — | — |
| EV2-0309 | CBA2-C15.6 | CBA | SRC2-001 | — | CBA XI §5(d)(1), p. 326 | Tight paraphrase: Its fourth-year Salary may change by no more than 4.5% of third-year Regular Salary | Supplies the independently judgeable requirement stated by CBA2-C15.6 | — | — |
| EV2-0310 | CBA2-C15.7 | CBA | SRC2-001 | — | CBA XI §5(d)(ii), p. 323 | The third/fourth-year jump route prohibits bonuses and requires 100% protection for lack of skill and injury or illness with no individually negotiated conditions | Supplies the later-year bonus and protection condition set | — | — |
| EV2-0311 | CBA2-C15.8 | CBA | SRC2-001 | — | CBA XI §5(d)(2), p. 326 | Tight paraphrase: The offering Team must have Room for Average Annual Salary and, if unmatched, includes that average in Team Salary for every covered Season | Supplies the independently judgeable requirement stated by CBA2-C15.8 | — | — |
| EV2-0312 | CBA2-C15.9 | CBA | SRC2-001 | — | CBA XI §5(d)(3), pp. 326–27 | Tight paraphrase: A matching ROFR Team ordinarily includes the stated annual Arenas salary schedule in Team Salary | Supplies the independently judgeable requirement stated by CBA2-C15.9 | — | — |
| EV2-0313 | CBA2-C15.10 | CBA | SRC2-001 | — | CBA XI §5(d)(3), pp. 326–27 | Tight paraphrase: A qualifying below-cap ROFR Team may elect to use Average Annual Salary instead of the stated schedule | Supplies the independently judgeable requirement stated by CBA2-C15.10 | — | — |
| EV2-0314 | CBA2-C15.11 | CBA | SRC2-001 | — | CBA XI §5(d)(iii), p. 324 | The ROFR Team must give the NBA a written statement the same day as the Exercise Notice, and the NBA must copy the Players Association within one business day | Supplies the election notice chain | — | — |
| EV2-0315 | CBA2-C15.12 | INFERRED | SRC2-001 | EV2-0304, EV2-0305, EV2-0306, EV2-0307, EV2-0308, EV2-0309, EV2-0310, EV2-0311, EV2-0312, EV2-0313, EV2-0314 | CBA XI §5(b)–(d), pp. 323–28 | Tight paraphrase: Arenas compliance requires the offer-year limits, later-year conditions, and each Team’s accounting treatment to pass independently | Supplies the independently judgeable requirement stated by CBA2-C15.12 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0316 | CBA2-C16.1 | CBA | SRC2-001 | — | CBA VIII §1(a), p. 290 | Tight paraphrase: A Rookie Scale Contract covers four Seasons: two initial Seasons followed by Team Options for the third and fourth Seasons | Supplies the independently judgeable requirement stated by CBA2-C16.1 | — | — |
| EV2-0317 | CBA2-C16.2 | CBA | SRC2-001 | — | CBA VIII §1(b), pp. 290–91 | Tight paraphrase: Rookie Scale Salary plus Unlikely Bonuses must be at least 80% and no more than 120% of the applicable Rookie Scale Amount, subject to the Minimum Player Salary floor | Supplies the independently judgeable requirement stated by CBA2-C16.2 | — | — |
| EV2-0318 | CBA2-C16.3 | CBA | SRC2-001 | — | CBA VIII §1(b)(2), p. 291 | Tight paraphrase: A First Round Pick signing on or after January 10 receives the applicable amount prorated over remaining Regular Season days | Supplies the independently judgeable requirement stated by CBA2-C16.3 | — | — |
| EV2-0319 | CBA2-C16.4 | CBA | SRC2-001 | — | CBA VIII §1(c)(2), p. 292 | Tight paraphrase: A Rookie Scale Team Option must be exercised by October 31 before the option Season, extended to the next business day for a weekend or federal holiday | Supplies the independently judgeable requirement stated by CBA2-C16.4 | — | — |
| EV2-0320 | CBA2-C16.5 | CBA | SRC2-001 | — | CBA VIII §1(c)(2), p. 292 | Tight paraphrase: Rookie Scale Team Option exercise requires written notice to the player and NBA | Supplies the independently judgeable requirement stated by CBA2-C16.5 | — | — |
| EV2-0321 | CBA2-C16.6 | CBA | SRC2-001 | — | CBA VIII §1(c)(2), p. 292 | Tight paraphrase: Failure to exercise either Rookie Scale Team Option makes the player an Unrestricted Free Agent after the preceding Season | Supplies the independently judgeable requirement stated by CBA2-C16.6 | — | — |
| EV2-0322 | CBA2-C16.7 | CBA | SRC2-001 | — | CBA VIII §1(c)(2), p. 292 | Tight paraphrase: After declining a Rookie Scale Team Option, the Prior Team may not offer first-year Salary plus Unlikely Bonuses above the declined amount | Supplies the independently judgeable requirement stated by CBA2-C16.7 | — | — |
| EV2-0323 | CBA2-C16.8 | CBA | SRC2-001 | — | CBA VIII §1(c)(3), pp. 292–93 | Tight paraphrase: The fourth-Season Rookie Scale Team Option carries the third-Season option’s terms and protection except for its prescribed salary schedule | Supplies the independently judgeable requirement stated by CBA2-C16.8 | — | — |
| EV2-0324 | CBA2-C16.9 | CBA | SRC2-001 | — | CBA VIII §1(b)(3), p. 291 | Tight paraphrase: A Rookie Scale Contract may not include a signing bonus or loan except for permitted international-player treatment | Supplies the independently judgeable requirement stated by CBA2-C16.9 | — | — |
| EV2-0325 | CBA2-C16.10 | CBA | SRC2-001 | — | CBA II §7(a), p. 36 | Tight paraphrase: Maximum Annual Salary is tested against first-Season Salary plus Unlikely Bonuses | Supplies the independently judgeable requirement stated by CBA2-C16.10 | — | — |
| EV2-0326 | CBA2-C16.11 | CBA | SRC2-001 | — | CBA II §7(a)(i), p. 36 | Tight paraphrase: For fewer than seven YOS, Maximum Annual Salary is the greater of 25% of the Salary Cap or 105% of prior Salary | Supplies the independently judgeable requirement stated by CBA2-C16.11 | — | — |
| EV2-0327 | CBA2-C16.12 | CBA | SRC2-001 | — | CBA II §7(a)(ii), p. 36 | Tight paraphrase: For seven through nine YOS, Maximum Annual Salary is the greater of 30% of the Salary Cap or 105% of prior Salary | Supplies the independently judgeable requirement stated by CBA2-C16.12 | — | — |
| EV2-0328 | CBA2-C16.13 | CBA | SRC2-001 | — | CBA II §7(a)(iii), p. 36 | Tight paraphrase: For ten or more YOS, Maximum Annual Salary is the greater of 35% of the Salary Cap or 105% of prior Salary | Supplies the independently judgeable requirement stated by CBA2-C16.13 | — | — |
| EV2-0329 | CBA2-C16.14 | CBA | SRC2-001 | — | CBA II §7(a)(1), pp. 36–38 | Tight paraphrase: Fifth Year Eligible Players may receive the Higher Max only through the specified MVP, Defensive Player of the Year, or All-NBA achievement alternatives and lookbacks | Supplies the independently judgeable requirement stated by CBA2-C16.14 | — | — |
| EV2-0330 | CBA2-C16.15 | CBA | SRC2-001 | — | CBA XXIX §6, pp. 488–90 | Tight paraphrase: Awards used for a Higher Max or Designated Veteran route must satisfy the Article XXIX §6 game threshold or an applicable injury or grievance determination | Supplies the independently judgeable requirement stated by CBA2-C16.15 | — | External determination is an input; the legal rule remains CBA-controlled |
| EV2-0331 | CBA2-C16.16 | CBA | SRC2-001 | — | CBA II §7(a)(2)(i), pp. 37–38 | Tight paraphrase: A Designated Veteran Player Contract requires the signed draft-team or trade-history route, Qualifying Veteran Free Agent status, and seven or eight YOS | Supplies the independently judgeable requirement stated by CBA2-C16.16 | — | — |
| EV2-0332 | CBA2-C16.17 | CBA | SRC2-001 | — | CBA II §7(a)(2)(i), p. 38 | Tight paraphrase: A Designated Veteran Player Contract may set first-year Salary between 30% and 35% of the Salary Cap as agreed | Supplies the independently judgeable requirement stated by CBA2-C16.17 | — | — |
| EV2-0333 | CBA2-C16.18 | CBA | SRC2-001 | — | CBA VII §7(a)(1), p. 249 | Tight paraphrase: A Rookie Scale Extension requires exercise of both Rookie Scale Team Options | Supplies the independently judgeable requirement stated by CBA2-C16.18 | — | — |
| EV2-0334 | CBA2-C16.19 | CBA | SRC2-001 | — | CBA VII §7(a)(1), p. 249 | Tight paraphrase: A Rookie Scale Extension may be signed only from the end of the July moratorium through 6 p.m. on the day before the fourth Contract Season’s first Regular Season game | Supplies the independently judgeable requirement stated by CBA2-C16.19 | — | — |
| EV2-0335 | CBA2-C16.20 | CBA | SRC2-001 | — | CBA II §7(b), pp. 38–39; VII §7(a)(1), p. 249 | Tight paraphrase: First-year Salary in a Rookie Scale Extension may reach the applicable Maximum Annual Salary | Supplies the independently judgeable requirement stated by CBA2-C16.20 | — | — |
| EV2-0336 | CBA2-C16.21 | CBA | SRC2-001 | — | CBA II §7(b), pp. 38–44 | Tight paraphrase: A Rookie Scale Extension may state a conditional first-year percentage between 25% and 30% of the Salary Cap under the Higher Max conditions | Supplies the independently judgeable requirement stated by CBA2-C16.21 | — | — |
| EV2-0337 | CBA2-C16.22 | CBA | SRC2-001 | — | CBA VII §§5(a)(2), 7(a)(1), pp. 227–28, 249 | Tight paraphrase: A Rookie Scale Extension’s term and annual changes must follow the signed limits, with changes no greater than eight percent of first-year Regular Salary | Supplies the independently judgeable requirement stated by CBA2-C16.22 | — | — |
| EV2-0338 | CBA2-C16.23 | CBA | SRC2-001 | — | CBA VII §7(a)(1), pp. 249–50 | Tight paraphrase: A three- or four-Season Veteran Contract may first be extended on its second anniversary, a five- or six-Season Contract on its third, and one- or two-Season Contracts are not extendable | Supplies the independently judgeable requirement stated by CBA2-C16.23 | — | — |
| EV2-0339 | CBA2-C16.24 | CBA | SRC2-001 | — | CBA VII §7(a)(1), pp. 249–51 | Tight paraphrase: A Veteran Extension generally requires no more than one Season remaining; when more remains, the CBA’s offseason restriction applies | Supplies the independently judgeable requirement stated by CBA2-C16.24 | — | — |
| EV2-0340 | CBA2-C16.25 | CBA | SRC2-001 | — | CBA VII §7(a)(2), pp. 251–53 | Tight paraphrase: Ordinary first-year extended Salary may not exceed the greater of 140% of final Regular Salary and 140% of EAPS, subject to the maximum | Supplies the independently judgeable requirement stated by CBA2-C16.25 | — | — |
| EV2-0341 | CBA2-C16.26 | CBA | SRC2-001 | — | CBA VII §7(a)(2), pp. 252–54 | Tight paraphrase: First-year extended Likely and Unlikely Bonuses must use the signed separate 140% and carry-forward adjustments | Supplies the independently judgeable requirement stated by CBA2-C16.26 | — | — |
| EV2-0342 | CBA2-C16.27 | CBA | SRC2-001 | — | CBA VII §§5(a)(2), 7(a)(1)–(2), pp. 227–28, 249–54 | Tight paraphrase: An ordinary Veteran Extension may add no more than four Seasons and may use annual changes no greater than eight percent | Supplies the independently judgeable requirement stated by CBA2-C16.27 | — | — |
| EV2-0343 | CBA2-C16.28 | CBA | SRC2-001 | — | CBA II §7(a)(2)(ii), pp. 39–40 | Tight paraphrase: A Designated Veteran Extension requires the original-team or permitted trade-history route, seven or eight YOS, and Qualifying Veteran status | Supplies the independently judgeable requirement stated by CBA2-C16.28 | — | — |
| EV2-0344 | CBA2-C16.29 | CBA | SRC2-001 | — | CBA II §7(a)(2)(ii), pp. 39–40 | Tight paraphrase: A Designated Veteran Extension requires a specified MVP, Defensive Player of the Year, or All-NBA achievement alternative | Supplies the independently judgeable requirement stated by CBA2-C16.29 | — | — |
| EV2-0345 | CBA2-C16.30 | CBA | SRC2-001 | — | CBA II §7(a)(2)(ii), pp. 39–40 | Tight paraphrase: A Designated Veteran Extension must cover the designated term and may set first-year extended Salary between 30% and 35% of the Salary Cap | Supplies the independently judgeable requirement stated by CBA2-C16.30 | — | — |
| EV2-0346 | CBA2-C16.31 | CBA | SRC2-001 | — | CBA II §7(a)(2)(ii), p. 40 | Tight paraphrase: A Contract containing a Designated Veteran Extension may not be traded for one year after signing | Supplies the independently judgeable requirement stated by CBA2-C16.31 | — | — |
| EV2-0347 | CBA2-C16.32 | CBA | SRC2-001 | — | CBA II §7(a)(2)(ii), p. 40 | Tight paraphrase: A Designated Veteran Extension may not include Incentive Compensation | Supplies the independently judgeable requirement stated by CBA2-C16.32 | — | — |
| EV2-0348 | CBA2-C16.33 | CBA | SRC2-001 | — | CBA X §1(b)(ii), pp. 296–99; VII §6, pp. 231–47 | Tight paraphrase: A player not selected in an NBA Draft becomes a Rookie Free Agent immediately after that Draft and may sign only through an independently valid mechanism | Supplies the independently judgeable requirement stated by CBA2-C16.33 | — | — |
| EV2-0349 | CBA2-C16.34 | INFERRED | SRC2-001 | EV2-0316, EV2-0317, EV2-0318, EV2-0319, EV2-0320, EV2-0321, EV2-0322, EV2-0323, EV2-0324 | CBA VIII §1, pp. 290–95 | Tight paraphrase: Rookie Scale Contract compliance requires shape, salary range, option timing and notice, declined-option consequences, and compensation restrictions | Supplies the independently judgeable requirement stated by CBA2-C16.34 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0350 | CBA2-C16.35 | INFERRED | SRC2-001 | EV2-0325, EV2-0326, EV2-0327, EV2-0328, EV2-0329, EV2-0330, EV2-0331, EV2-0332 | CBA II §7(a)–(b), pp. 36–44; XXIX §6, pp. 488–90 | Tight paraphrase: Maximum-salary compliance requires the YOS tier, 105%-of-prior branch, and any Higher Max or designated route | Supplies the independently judgeable requirement stated by CBA2-C16.35 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0351 | CBA2-C16.36 | INFERRED | SRC2-001 | EV2-0333, EV2-0334, EV2-0335, EV2-0336, EV2-0337 | CBA II §7(b), pp. 38–44; VII §7(a), pp. 249–54 | Tight paraphrase: Rookie Scale Extension compliance requires exercised options, signing window, starting maximum, term, and raise rules | Supplies the independently judgeable requirement stated by CBA2-C16.36 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0352 | CBA2-C16.37 | INFERRED | SRC2-001 | EV2-0338, EV2-0339, EV2-0340, EV2-0341, EV2-0342, EV2-0343, EV2-0344, EV2-0345, EV2-0346, EV2-0347 | CBA II §7(a)(2), pp. 37–44; VII §7(a), pp. 249–54 | Tight paraphrase: Veteran and Designated Veteran Extension compliance requires timing, compensation, term, status, awards, trade, and incentive rules | Supplies the independently judgeable requirement stated by CBA2-C16.37 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0353 | CBA2-C17.1 | CBA | SRC2-001 | — | CBA VII §3(a)(2)(i), p. 198 | Tight paraphrase: The general Over-38 rule applies to a Contract, Extension, or Renegotiation covering at least four Seasons and a Season after the player turns 38 | Supplies the independently judgeable requirement stated by CBA2-C17.1 | — | — |
| EV2-0354 | CBA2-C17.2 | CBA | SRC2-001 | — | CBA VII §3(a)(2)(i), p. 198 | Tight paraphrase: Over-38 age is ordinarily measured on October 1 of the covered Season | Supplies the independently judgeable requirement stated by CBA2-C17.2 | — | — |
| EV2-0355 | CBA2-C17.3 | CBA | SRC2-001 | — | CBA VII §3(a)(2)(i), p. 198 | Tight paraphrase: For a July-moratorium Contract and a birthday in that period, Over-38 age is measured as of the preceding June 30 | Supplies the independently judgeable requirement stated by CBA2-C17.3 | — | — |
| EV2-0356 | CBA2-C17.4 | CBA | SRC2-001 | — | CBA VII §3(a)(2)(i), pp. 198–99 | Tight paraphrase: The general first zero-attribution Season is the later of the fourth Contract Season or the first October 1 on which the player is 38 | Supplies the independently judgeable requirement stated by CBA2-C17.4 | — | — |
| EV2-0357 | CBA2-C17.5 | CBA | SRC2-001 | — | CBA VII §3(a)(2)(i), pp. 198–200 | Tight paraphrase: Salary from an Over-38 zero Season is allocated proportionally among non-zero Seasons under the signed formula | Supplies the independently judgeable requirement stated by CBA2-C17.5 | — | — |
| EV2-0358 | CBA2-C17.6 | CBA | SRC2-001 | — | CBA VII §3(a)(2)(ii), p. 199 | Tight paraphrase: A 35- or 36-year-old QVFA re-signing with the Prior Team avoids reallocation for no more than four Seasons; on five Seasons only Year 5 is zero | Supplies the independently judgeable requirement stated by CBA2-C17.6 | — | — |
| EV2-0359 | CBA2-C17.7 | CBA | SRC2-001 | — | CBA VII §3(a)(2)(ii), p. 199 | Tight paraphrase: The 35/36 Qualifying Veteran exception does not apply to a Sign-and-Trade Contract | Supplies the independently judgeable requirement stated by CBA2-C17.7 | — | — |
| EV2-0360 | CBA2-C17.8 | CBA | SRC2-001 | — | CBA VII §3(a)(2)(iii), pp. 199–200 | Tight paraphrase: Over-38 attribution is recomputed each July 1 beginning two years before the first zero Season while the Contract remains active | Supplies the independently judgeable requirement stated by CBA2-C17.8 | — | — |
| EV2-0361 | CBA2-C17.9 | INFERRED | SRC2-001 | EV2-0353, EV2-0354, EV2-0355, EV2-0356, EV2-0357, EV2-0358, EV2-0359, EV2-0360 | CBA VII §3(a)(2), pp. 198–200 | Tight paraphrase: Over-38 compliance requires the correct age date, trigger, zero Season, allocation, special QVFA route, and recurring reattribution | Supplies the independently judgeable requirement stated by CBA2-C17.9 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0362 | CBA2-C18.1 | CBA | SRC2-001 | — | CBA VII §3(b)(2), pp. 201–03 | Tight paraphrase: An ordinary signing bonus is allocated among Salary Cap Years in proportion to Base Compensation protected for lack of skill | Supplies the independently judgeable requirement stated by CBA2-C18.1 | — | — |
| EV2-0363 | CBA2-C18.2 | CBA | SRC2-001 | — | CBA VII §3(b)(2), p. 202 | Tight paraphrase: An ETO Season is excluded from ordinary signing-bonus allocation | Supplies the independently judgeable requirement stated by CBA2-C18.2 | — | — |
| EV2-0364 | CBA2-C18.3 | CBA | SRC2-001 | — | CBA VII §3(b)(2), pp. 202–03 | Tight paraphrase: If no future Season has protected Base Compensation, the unallocated ordinary signing bonus is attributed to the first Salary Cap Year | Supplies the independently judgeable requirement stated by CBA2-C18.3 | — | — |
| EV2-0365 | CBA2-C18.4 | CBA | SRC2-001 | — | CBA VII §3(b)(1)(ii), §3(b)(2), pp. 201–03 | Tight paraphrase: A trade bonus earned during a Contract is allocated only to the current and remaining Salary Cap Years under protected-percentage rules | Supplies the independently judgeable requirement stated by CBA2-C18.4 | — | — |
| EV2-0366 | CBA2-C18.5 | CBA | SRC2-001 | — | CBA VII §3(b)(3)(i), pp. 203–04 | Tight paraphrase: An Extension bonus paid at or above the Cap may be paid no sooner than the first extended Salary Cap Year and is allocated only over the extended term | Supplies the independently judgeable requirement stated by CBA2-C18.5 | — | — |
| EV2-0367 | CBA2-C18.6 | CBA | SRC2-001 | — | CBA VII §3(b)(3)(i), p. 204 | Tight paraphrase: If no extended Season has protected Base Compensation in that branch, the bonus is attributed to the first extended Salary Cap Year | Supplies the independently judgeable requirement stated by CBA2-C18.6 | — | — |
| EV2-0368 | CBA2-C18.7 | CBA | SRC2-001 | — | CBA VII §3(b)(3)(ii), pp. 204–05 | Tight paraphrase: A below-cap Extension bonus paid on or after the first extended Salary Cap Year uses the same extended-term-only allocation and fallback | Supplies the independently judgeable requirement stated by CBA2-C18.7 | — | — |
| EV2-0369 | CBA2-C18.8 | CBA | SRC2-001 | — | CBA VII §3(b)(3)(ii)(A), p. 205 | Tight paraphrase: A below-cap Extension bonus paid early is allocated over remaining original and extended Seasons by protected Base Compensation, with zero in the signing year | Supplies the independently judgeable requirement stated by CBA2-C18.8 | — | — |
| EV2-0370 | CBA2-C18.9 | CBA | SRC2-001 | — | CBA VII §3(b)(3)(ii)(B), p. 205 | Tight paraphrase: A below-cap early-paid Extension bonus is deemed a Renegotiation for Salary Cap purposes | Supplies the independently judgeable requirement stated by CBA2-C18.9 | — | — |
| EV2-0371 | CBA2-C18.10 | CBA | SRC2-001 | — | CBA VII §3(b)(3)(ii)(C), p. 205 | Tight paraphrase: A below-cap early-paid Extension bonus must be paid in two equal installments on the specified dates | Supplies the independently judgeable requirement stated by CBA2-C18.10 | — | — |
| EV2-0372 | CBA2-C18.11 | CBA | SRC2-001 | — | CBA VII §3(b)(3)(iii), pp. 205–06 | Tight paraphrase: If an Extension removes the original trade-bonus provision, a previously earned trade bonus remains allocated over the original term only | Supplies the independently judgeable requirement stated by CBA2-C18.11 | — | — |
| EV2-0373 | CBA2-C18.12 | CBA | SRC2-001 | — | CBA VII §3(b)(3)(iv)–(v), pp. 206–07 | Tight paraphrase: If an Extension retains the trade-bonus provision, the signed assumed-trade, installment, and maximum-adjustment rules govern extended allocation | Supplies the independently judgeable requirement stated by CBA2-C18.12 | — | — |
| EV2-0374 | CBA2-C18.13 | INFERRED | SRC2-001 | EV2-0362, EV2-0363, EV2-0364, EV2-0365 | CBA VII §3(b)(1)–(2), pp. 201–03 | Tight paraphrase: General signing-bonus allocation requires the protected-percentage basis, ETO exclusion, zero-protection fallback, and trade-earned remaining-year boundary | Supplies the independently judgeable requirement stated by CBA2-C18.13 | Inference over the cited primary text and listed direct components | Direct component owners control |

| EV2-0375 | CBA2-C19.1 | CBA | SRC2-001 | — | CBA II §9(a), p. 48 | Tight paraphrase: A Team may first enter a Ten-Day Contract on January 5 | Supplies the independently judgeable requirement stated by CBA2-C19.1 | — | — |
| EV2-0376 | CBA2-C19.2 | CBA | SRC2-001 | — | CBA II §9(a), pp. 48–49 | Tight paraphrase: A Ten-Day Contract lasts the longer of ten days or three scheduled team games | Supplies the independently judgeable requirement stated by CBA2-C19.2 | — | — |
| EV2-0377 | CBA2-C19.3 | CBA | SRC2-001 | — | CBA II §9(a), p. 48 | Tight paraphrase: A Ten-Day Contract must pay at least the applicable Minimum Player Salary prorated for its stated term | Supplies the independently judgeable requirement stated by CBA2-C19.3 | — | — |
| EV2-0378 | CBA2-C19.4 | CBA | SRC2-001 | — | CBA II §9(a), p. 48 | Tight paraphrase: A Team may sign the same player to no more than two Ten-Day Contracts in one Season | Supplies the independently judgeable requirement stated by CBA2-C19.4 | — | — |
| EV2-0379 | CBA2-C19.5 | CBA | SRC2-001 | — | CBA II §9(b), pp. 48–49 | Tight paraphrase: Concurrent ordinary Ten-Day capacity is zero, one, two, or three for respectively 12, 13, 14, or 15 Standard roster players | Supplies the independently judgeable requirement stated by CBA2-C19.5 | — | — |
| EV2-0380 | CBA2-C19.6 | CBA | SRC2-001 | — | CBA II §9(c), p. 49 | Tight paraphrase: A hardship Ten-Day Contract may be entered outside the ordinary January 5 window when the hardship authorization applies | Supplies the independently judgeable requirement stated by CBA2-C19.6 | — | — |
| EV2-0381 | CBA2-C19.7 | CBA | SRC2-001 | — | CBA II §9(c), p. 49 | Tight paraphrase: A hardship Ten-Day Contract may use the shorter term authorized by the hardship provision | Supplies the independently judgeable requirement stated by CBA2-C19.7 | — | — |
| EV2-0382 | CBA2-C19.8 | CBA | SRC2-001 | — | CBA II §9(a), p. 48 | Tight paraphrase: A Ten-Day Contract may not have a stated term extending to or beyond the Team’s last Regular Season game | Supplies the independently judgeable requirement stated by CBA2-C19.8 | — | — |
| EV2-0383 | CBA2-C19.9 | CBA | SRC2-001 | — | CBA II §9(d), p. 49 | Tight paraphrase: Written termination of a Ten-Day Contract is effective immediately without waivers | Supplies the independently judgeable requirement stated by CBA2-C19.9 | — | — |
| EV2-0384 | CBA2-C19.10 | CBA | SRC2-001 | — | CBA II §9(d), p. 49 | Tight paraphrase: After Ten-Day termination, the Team owes only compensation earned through termination and expressly accrued amounts | Supplies the independently judgeable requirement stated by CBA2-C19.10 | — | — |
| EV2-0385 | CBA2-C19.11 | CBA | SRC2-001 | — | CBA II §9(d), pp. 49–50 | Tight paraphrase: A player whose Ten-Day Contract was terminated may not sign another NBA Contract before the original stated term expires | Supplies the independently judgeable requirement stated by CBA2-C19.11 | — | — |
| EV2-0386 | CBA2-C19.12 | CBA | SRC2-001 | — | CBA II §9(e), p. 50 | Tight paraphrase: During a Ten-Day Contract, the parties may negotiate a Rest-of-Season Contract effective the day after the stated Ten-Day term expires | Supplies the independently judgeable requirement stated by CBA2-C19.12 | — | — |
| EV2-0387 | CBA2-C19.13 | CBA | SRC2-001 | — | CBA II §10(a), p. 50 | Tight paraphrase: A Rest-of-Season Contract may be entered only after the first Regular Season day and covers compensation for the remainder of that Season | Supplies the independently judgeable requirement stated by CBA2-C19.13 | — | — |
| EV2-0388 | CBA2-C19.14 | CBA | SRC2-001 | — | CBA II §10(b), p. 50 | Tight paraphrase: A Rest-of-Season Contract must provide at least the applicable Minimum Player Salary prorated for remaining Regular Season days | Supplies the independently judgeable requirement stated by CBA2-C19.14 | — | — |
| EV2-0389 | CBA2-C19.15 | CBA | SRC2-001 | — | CBA II §10(c), p. 50 | Tight paraphrase: A Two-Way Contract is not a Rest-of-Season Contract for Article II §10 | Supplies the independently judgeable requirement stated by CBA2-C19.15 | — | — |
| EV2-0390 | CBA2-C19.16 | CBA | SRC2-001 | — | CBA II §10(b), p. 50; I §1(eee), p. 7 | Tight paraphrase: Rest-of-Season proration multiplies the full-season amount by remaining Regular Season days divided by total Regular Season days | Supplies the independently judgeable requirement stated by CBA2-C19.16 | — | — |
| EV2-0391 | CBA2-C19.17 | INFERRED | SRC2-001 | EV2-0390 | CBA II §10(b), p. 50; VII §§2, 4, 6, pp. 172–247 | Tight paraphrase: A prorated Rest-of-Season Salary must flow consistently into each ledger or exception calculation that consumes that Salary | Supplies the independently judgeable requirement stated by CBA2-C19.17 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0392 | CBA2-C19.18 | INFERRED | SRC2-001 | EV2-0375, EV2-0376, EV2-0377, EV2-0378, EV2-0379, EV2-0380, EV2-0381, EV2-0382, EV2-0383, EV2-0384, EV2-0385, EV2-0386 | CBA II §9, pp. 48–50 | Tight paraphrase: Ten-Day compliance requires the opening, duration, minimum, count, capacity, hardship, final-game, and termination rules | Supplies the independently judgeable requirement stated by CBA2-C19.18 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0393 | CBA2-C19.19 | INFERRED | SRC2-001 | EV2-0387, EV2-0388, EV2-0389, EV2-0390, EV2-0391, EV2-0502 | CBA II §10, p. 50; IX §1, p. 295 | The Rest-of-Season rules govern current-year compensation and do not state a shorter Contract term than Article IX | Supplies complete Rest-of-Season routing including future Seasons | Inference over the listed direct components | Direct component owners control |
| EV2-0394 | CBA2-C20.1 | CBA | SRC2-001 | — | CBA II §11(b), pp. 52–53 | Tight paraphrase: A Team may have no more than three Two-Way Players on its roster at one time | Supplies the independently judgeable requirement stated by CBA2-C20.1 | — | — |
| EV2-0395 | CBA2-C20.2 | CBA | SRC2-001 | — | CBA II §11(b), pp. 52–53 | Tight paraphrase: A Two-Way Player does not occupy a Standard Active or Inactive List position | Supplies the independently judgeable requirement stated by CBA2-C20.2 | — | — |
| EV2-0396 | CBA2-C20.3 | CBA | SRC2-001 | — | CBA VII §4(j), p. 226 | Tight paraphrase: Two-Way Salary is excluded from Team Salary | Supplies the independently judgeable requirement stated by CBA2-C20.3 | — | — |
| EV2-0397 | CBA2-C20.4 | CBA | SRC2-001 | — | CBA II §11(a)(ii), pp. 50–51 | Tight paraphrase: Full-season Two-Way Base Compensation equals 50% of the zero-YOS Minimum Player Salary | Supplies the independently judgeable requirement stated by CBA2-C20.4 | — | — |
| EV2-0398 | CBA2-C20.5 | CBA | SRC2-001 | — | CBA II §11(a)(ii), p. 51 | Tight paraphrase: A Two-Way signed after the Season begins prorates Base Compensation over remaining Regular Season days | Supplies the independently judgeable requirement stated by CBA2-C20.5 | — | — |
| EV2-0399 | CBA2-C20.6 | CBA | SRC2-001 | — | CBA II §11(a)(iii), p. 51 | Tight paraphrase: A Two-Way Contract may not include bonuses | Supplies the independently judgeable requirement stated by CBA2-C20.6 | — | — |
| EV2-0400 | CBA2-C20.7 | CBA | SRC2-001 | — | CBA II §11(a)(iii), p. 51 | Tight paraphrase: A Two-Way Contract may not include Incentive Compensation | Supplies the independently judgeable requirement stated by CBA2-C20.7 | — | — |
| EV2-0401 | CBA2-C20.8 | CBA | SRC2-001 | — | CBA II §11(a)(iii), p. 51 | Tight paraphrase: A Two-Way Contract may not include deferred compensation | Supplies the independently judgeable requirement stated by CBA2-C20.8 | — | — |
| EV2-0402 | CBA2-C20.9 | CBA | SRC2-001 | — | CBA II §11(a)(iii), p. 51 | Tight paraphrase: A Two-Way Contract may not include a loan | Supplies the independently judgeable requirement stated by CBA2-C20.9 | — | — |
| EV2-0403 | CBA2-C20.10 | INFERRED | SRC2-001 | EV2-0503, EV2-0504 | CBA II §11(a)(v), pp. 51–52 | Separate sentences govern Advance eligibility/limit and installment deductions | Supplies one staged Advance-compliance verdict | Inference over two direct components | Direct component owners control |
| EV2-0404 | CBA2-C20.11 | CBA | SRC2-001 | — | CBA II §11(d), p. 54 | Tight paraphrase: A Two-Way Contract may cover no more than two Seasons | Supplies the independently judgeable requirement stated by CBA2-C20.11 | — | — |
| EV2-0405 | CBA2-C20.12 | CBA | SRC2-001 | — | CBA II §11(d), p. 54 | Tight paraphrase: A Two-Way Contract may not include an Option Year | Supplies the independently judgeable requirement stated by CBA2-C20.12 | — | — |
| EV2-0406 | CBA2-C20.13 | CBA | SRC2-001 | — | CBA II §11(d), p. 54 | Tight paraphrase: A Two-Way Contract may not include an Early Termination Option | Supplies the independently judgeable requirement stated by CBA2-C20.13 | — | — |
| EV2-0407 | CBA2-C20.14 | CBA | SRC2-001 | — | CBA II §11(e), p. 54 | Tight paraphrase: A player generally must have fewer than four YOS when a Two-Way Contract is signed | Supplies the independently judgeable requirement stated by CBA2-C20.14 | — | — |
| EV2-0408 | CBA2-C20.15 | CBA | SRC2-001 | — | CBA II §11(e), p. 54 | Tight paraphrase: A four-YOS player may sign only the narrow one-Season Two-Way permitted by the signed exception | Supplies the independently judgeable requirement stated by CBA2-C20.15 | — | — |
| EV2-0409 | CBA2-C20.16 | CBA | SRC2-001 | — | CBA II §11(e), p. 54 | Tight paraphrase: A player may not be under a Two-Way with the same Team in more than three Salary Cap Years | Supplies the independently judgeable requirement stated by CBA2-C20.16 | — | — |
| EV2-0410 | CBA2-C20.17 | CBA | SRC2-001 | — | CBA II §11(e)(i), p. 54 | Tight paraphrase: A Team may not sign a player to a Two-Way Contract after March 4 of that Season | Supplies the independently judgeable requirement stated by CBA2-C20.17 | — | — |
| EV2-0411 | CBA2-C20.18 | CBA | SRC2-001 | — | CBA II §11(f), pp. 54–56 | Tight paraphrase: A Two-Way conversion may occur from July 1 through the day before the Team’s final Regular Season game | Supplies the independently judgeable requirement stated by CBA2-C20.18 | — | — |
| EV2-0412 | CBA2-C20.19 | CBA | SRC2-001 | — | CBA II §11(f), pp. 54–55 | Tight paraphrase: A Standard Conversion Option produces a Standard Contract at the applicable Minimum Player Salary | Supplies the independently judgeable requirement stated by CBA2-C20.19 | — | — |
| EV2-0413 | CBA2-C20.20 | CBA | SRC2-001 | — | CBA II §11(f), pp. 54–56 | Tight paraphrase: The converted Standard Contract keeps the same remaining term, with compensation credited as the signed rule requires | Supplies the independently judgeable requirement stated by CBA2-C20.20 | — | — |
| EV2-0414 | CBA2-C20.21 | CBA | SRC2-001 | — | CBA II §11(g), p. 56; VII §6, pp. 231–47 | Tight paraphrase: A newly negotiated Standard replacement requires independently available Room or exception authority | Supplies the independently judgeable requirement stated by CBA2-C20.21 | — | — |
| EV2-0415 | CBA2-C20.22 | CBA | SRC2-001 | — | CBA II §11(g), p. 56 | Tight paraphrase: A newly negotiated Standard replacement may not include Exhibit 10 and immediately voids the prior Two-Way | Supplies the independently judgeable requirement stated by CBA2-C20.22 | — | — |
| EV2-0416 | CBA2-C20.23 | CBA | SRC2-001 | — | CBA II §11(b)(ii), p. 52 | The 50-game maximum is prorated by remaining days, rounded, and never below one | Supplies the Active List game limit | — | — |
| EV2-0417 | CBA2-C20.24 | CBA | SRC2-001 | — | CBA II §11(b)(iii), pp. 52–53 | The 90 Under-Fifteen maximum counts each game by the number of Two-Way Players active | Supplies the weighted usage limit | — | — |
| EV2-0418 | CBA2-C20.25 | CBA | SRC2-001 | — | CBA II §11(c)(i)–(ii), p. 53 | The preseason maximum is $75,000 indexed from the 2023-24 Cap; a post-start signing is capped at 50% of Base Compensation | Supplies the timing-routed protection maximum | — | — |
| EV2-0419 | CBA2-C20.26 | CBA | SRC2-001 | — | CBA II §11(c), pp. 53–54 | Tight paraphrase: Excess Two-Way protection after assignment or termination triggers the signed affiliate and same-Team restrictions | Supplies the independently judgeable requirement stated by CBA2-C20.26 | — | — |
| EV2-0420 | CBA2-C20.27 | CBA | SRC2-001 | — | CBA II §11(i), pp. 58–59 | Tight paraphrase: A Team retains exclusive NBA negotiating rights to its Two-Way player until a signed conversion, replacement, assignment, or termination event | Supplies the independently judgeable requirement stated by CBA2-C20.27 | — | — |
| EV2-0421 | CBA2-C20.28 | INFERRED | SRC2-001 | EV2-0394, EV2-0395, EV2-0396, EV2-0397, EV2-0398, EV2-0399, EV2-0400, EV2-0401, EV2-0402, EV2-0403, EV2-0404, EV2-0405, EV2-0406, EV2-0407, EV2-0408, EV2-0409, EV2-0410, EV2-0411, EV2-0412, EV2-0413, EV2-0414, EV2-0415, EV2-0416, EV2-0417, EV2-0418, EV2-0419, EV2-0420 | CBA II §11, pp. 50–59; VII §4(j), p. 226 | Tight paraphrase: Two-Way compliance requires roster, salary, compensation shape, term, eligibility, timing, conversion, usage, protection, and rights rules | Supplies the independently judgeable requirement stated by CBA2-C20.28 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0422 | CBA2-C21.1 | INFERRED | SRC2-001 | EV2-0506, EV2-0507, EV2-0508, EV2-0509 | CBA II §3(r), pp. 20–21 | Separate terms govern Exhibit 9 term, salary, bonus, and protection | Supplies staged Exhibit 9 shape compliance | Inference over four direct components | Direct component owners control |
| EV2-0423 | CBA2-C21.2 | CBA | SRC2-001 | — | CBA II §3(r), p. 21 | Tight paraphrase: An Exhibit 9 Team must have at least 14 other players under non-Exhibit-9 Standard Contracts | Supplies the independently judgeable requirement stated by CBA2-C21.2 | — | — |
| EV2-0424 | CBA2-C21.3 | CBA | SRC2-001 | — | CBA II §3(r), p. 21 | Tight paraphrase: A Team may have no more than six Exhibit 9 Contracts at one time | Supplies the independently judgeable requirement stated by CBA2-C21.3 | — | — |
| EV2-0425 | CBA2-C21.4 | CBA | SRC2-001 | — | CBA II §3(r), pp. 20–21 | Tight paraphrase: A qualifying Exhibit 9 must provide the cap-indexed injury termination protection amount | Supplies the independently judgeable requirement stated by CBA2-C21.4 | — | — |
| EV2-0426 | CBA2-C21.5 | CBA | SRC2-001 | — | CBA II §3(r), p. 21 | Tight paraphrase: Exhibit 9 injury protection is eliminated when termination is for lack of skill | Supplies the independently judgeable requirement stated by CBA2-C21.5 | — | — |
| EV2-0427 | CBA2-C21.6 | CBA | SRC2-001 | — | CBA II §3(s), pp. 21–24 | Tight paraphrase: An Exhibit 10 must attach to a one-Season Standard Contract at the Minimum Player Salary | Supplies the independently judgeable requirement stated by CBA2-C21.6 | — | — |
| EV2-0428 | CBA2-C21.7 | CBA | SRC2-001 | — | CBA II §3(s), pp. 21–24 | Tight paraphrase: An Exhibit 10 Contract may contain no other bonus or protection beyond the governed Exhibit 10 amounts | Supplies the independently judgeable requirement stated by CBA2-C21.7 | — | — |
| EV2-0429 | CBA2-C21.8 | CBA | SRC2-001 | — | CBA II §3(s), p. 23 | Tight paraphrase: A Team may have no more than six Exhibit 10 Contracts at one time | Supplies the independently judgeable requirement stated by CBA2-C21.8 | — | — |
| EV2-0430 | CBA2-C21.9 | CBA | SRC2-001 | — | CBA II §3(s), pp. 21–22 | Tight paraphrase: An Exhibit 10 bonus must be at least $5,000 and no more than the cap-indexed maximum | Supplies the independently judgeable requirement stated by CBA2-C21.9 | — | — |
| EV2-0431 | CBA2-C21.10 | INFERRED | SRC2-001 | EV2-0510, EV2-0511, EV2-0512 | CBA II §3(s), pp. 21–22 | Separate terms govern waiver, designation, and reporting | Supplies staged Exhibit 10 entry compliance | Inference over three direct components | Direct component owners control |
| EV2-0432 | CBA2-C21.11 | CBA | SRC2-001 | — | CBA II §3(s), p. 22 | Tight paraphrase: The designated player generally must remain with the affiliate for 60 consecutive days | Supplies the independently judgeable requirement stated by CBA2-C21.11 | — | — |
| EV2-0433 | CBA2-C21.12 | CBA | SRC2-001 | — | CBA II §3(s), p. 22 | Tight paraphrase: The signed Contract interruption and return exception preserves qualifying service only under its timing conditions | Supplies the independently judgeable requirement stated by CBA2-C21.12 | — | — |
| EV2-0434 | CBA2-C21.13 | CBA | SRC2-001 | — | CBA II §3(s), p. 22 | Tight paraphrase: Signing with another professional team before qualifying affiliate service defeats the Exhibit 10 bonus | Supplies the independently judgeable requirement stated by CBA2-C21.13 | — | — |
| EV2-0435 | CBA2-C21.14 | CBA | SRC2-001 | — | CBA II §3(s), pp. 22–23 | Tight paraphrase: A qualifying affiliate injury can satisfy the service condition under the signed medical and roster requirements | Supplies the independently judgeable requirement stated by CBA2-C21.14 | — | — |
| EV2-0436 | CBA2-C21.15 | CBA | SRC2-001 | — | CBA II §11(h), pp. 56–58 | Tight paraphrase: Exhibit 10 conversion to Two-Way must occur before the first Regular Season day and satisfy Article X eligibility | Supplies the independently judgeable requirement stated by CBA2-C21.15 | — | — |
| EV2-0437 | CBA2-C21.16 | INFERRED | SRC2-001 | EV2-0513, EV2-0514 | CBA II §11(h), pp. 56–58 | Conversion separately rescinds the bonus and creates the stated protection | Supplies staged conversion consequences | Inference over two direct components | Direct component owners control |
| EV2-0438 | CBA2-C21.17 | CBA | SRC2-001 | — | CBA II §3(s); §11(h), pp. 21–24, 56–58 | Tight paraphrase: When both are present, the Exhibit 10 bonus and conversion-protection amount must be equal | Supplies the independently judgeable requirement stated by CBA2-C21.17 | — | — |
| EV2-0439 | CBA2-C21.18 | CBA | SRC2-001 | — | CBA II §3(s), pp. 23–24 | Tight paraphrase: Acquiring a converted Exhibit 10 Contract can create a deemed Exhibit 10 bonus under the signed conditions | Supplies the independently judgeable requirement stated by CBA2-C21.18 | — | — |
| EV2-0440 | CBA2-C21.19 | CBA | SRC2-001 | — | CBA VII §4(k), p. 226 | Tight paraphrase: A qualifying Exhibit 10 bonus is excluded from Team Salary | Supplies the independently judgeable requirement stated by CBA2-C21.19 | — | — |
| EV2-0441 | CBA2-C21.20 | CBA | SRC2-001 | — | CBA II §3(s), pp. 23–24 | Tight paraphrase: The designating Team must provide the signed returning-rights notice, and failure triggers the stated minimum fine | Supplies the independently judgeable requirement stated by CBA2-C21.20 | — | — |
| EV2-0442 | CBA2-C21.21 | CBA | SRC2-001 | — | CBA VII §4(i), p. 225 | Tight paraphrase: Salary under a Summer Contract is excluded from Team Salary through the day before the first Regular Season day | Supplies the independently judgeable requirement stated by CBA2-C21.21 | — | — |
| EV2-0443 | CBA2-C21.22 | CBA | SRC2-001 | — | CBA VII §4(i), pp. 225–26 | Tight paraphrase: A Summer Contract retained into the Regular Season requires Room or an applicable exception by the signed deadline | Supplies the independently judgeable requirement stated by CBA2-C21.22 | — | — |
| EV2-0444 | CBA2-C21.23 | INFERRED | SRC2-001 | EV2-0422, EV2-0423, EV2-0424, EV2-0425, EV2-0426 | CBA II §3(r), pp. 20–21 | Tight paraphrase: Exhibit 9 compliance requires shape, other-roster count, maximum count, injury protection, and termination basis | Supplies the independently judgeable requirement stated by CBA2-C21.23 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0445 | CBA2-C21.24 | INFERRED | SRC2-001 | EV2-0427, EV2-0428, EV2-0429, EV2-0430, EV2-0431, EV2-0432, EV2-0433, EV2-0434, EV2-0435, EV2-0436, EV2-0437, EV2-0438, EV2-0439, EV2-0440, EV2-0441 | CBA II §3(s), pp. 21–24; II §11(h), pp. 56–58; VII §4(k), p. 226 | Tight paraphrase: Exhibit 10 compliance requires shape, count, amount, payment, conversion, acquisition, Team Salary, and notice rules | Supplies the independently judgeable requirement stated by CBA2-C21.24 | Inference over the cited primary text and listed direct components | Direct component owners control |

| EV2-0446 | CBA2-C22.1 | CBA | SRC2-001 | — | CBA II §4(i), pp. 31–32 | Tight paraphrase: A later Season’s lack-of-skill protected percentage generally may not exceed the preceding Season’s protected percentage | Supplies the independently judgeable requirement stated by CBA2-C22.1 | — | — |
| EV2-0447 | CBA2-C22.2 | CBA | SRC2-001 | — | CBA II §4(i), p. 32 | Tight paraphrase: A later protected percentage may exceed the preceding one only when its condition could not be satisfied before the preceding Season ended | Supplies the independently judgeable requirement stated by CBA2-C22.2 | — | — |
| EV2-0448 | CBA2-C22.3 | CBA | SRC2-001 | — | CBA II §6(f), p. 35 | Tight paraphrase: A Minimum Player Salary Contract generally may not include a bonus | Supplies the independently judgeable requirement stated by CBA2-C22.3 | — | — |
| EV2-0449 | CBA2-C22.4 | CBA | SRC2-001 | — | CBA II §§3(s), 6(c), 6(f), pp. 21–24, 34–35 | Tight paraphrase: The Minimum Contract bonus bar permits only the signed trade-bonus, Exhibit 10, and international-player payment treatments | Supplies the independently judgeable requirement stated by CBA2-C22.4 | — | — |
| EV2-0450 | CBA2-C22.5 | CBA | SRC2-001 | — | CBA II §7(c), pp. 39–40 | Tight paraphrase: A percentage-based future Maximum Annual Salary must be recalculated on the applicable July 1 against the actual Salary Cap | Supplies the independently judgeable requirement stated by CBA2-C22.5 | — | — |
| EV2-0451 | CBA2-C22.6 | CBA | SRC2-001 | — | CBA II §7(c), pp. 39–40 | Tight paraphrase: Excess above the adjusted future maximum is reduced first from signing-bonus allocation | Supplies the independently judgeable requirement stated by CBA2-C22.6 | — | — |
| EV2-0452 | CBA2-C22.7 | CBA | SRC2-001 | — | CBA II §7(c), p. 40 | Tight paraphrase: After signing-bonus allocation is exhausted, remaining excess is reduced from bonus compensation pro rata | Supplies the independently judgeable requirement stated by CBA2-C22.7 | — | — |
| EV2-0453 | CBA2-C22.8 | CBA | SRC2-001 | — | CBA II §7(c), p. 40 | Tight paraphrase: After the first two tiers, remaining excess is reduced from Base Compensation and later annual amounts are adjusted proportionally | Supplies the independently judgeable requirement stated by CBA2-C22.8 | — | — |
| EV2-0454 | CBA2-C22.9 | INFERRED | SRC2-001 | EV2-0515, EV2-0516, EV2-0517 | CBA VII §5(a), pp. 227–28 | Separate terms govern the five-percent default, eight-percent routes, and first-year base | Supplies staged annual-change compliance | Inference over three direct components | Direct component owners control |
| EV2-0455 | CBA2-C22.10 | CBA | SRC2-001 | — | CBA VII §§5(a), 8(e), pp. 227–28, 263–66 | Tight paraphrase: Sign-and-Trade and Extension-and-Trade Contracts use their separately stricter annual-change rules | Supplies the independently judgeable requirement stated by CBA2-C22.10 | — | — |
| EV2-0456 | CBA2-C22.11 | INFERRED | SRC2-001 | EV2-0446, EV2-0447, EV2-0448, EV2-0449, EV2-0450, EV2-0451, EV2-0452, EV2-0453, EV2-0454, EV2-0455 | CBA II §§4(i), 6(f), 7(c), pp. 31–40; VII §5(a), pp. 227–28 | Tight paraphrase: Compensation-shape compliance requires protection progression, Minimum exceptions, maximum adjustment order, and annual-change rules | Supplies the independently judgeable requirement stated by CBA2-C22.11 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0457 | CBA2-C23.1 | CBA | SRC2-001 | — | CBA II §12(a)(i), p. 59 | Tight paraphrase: Total Incentive Compensation in a Season may not exceed 20% of Regular Salary for that Season | Supplies the independently judgeable requirement stated by CBA2-C23.1 | — | — |
| EV2-0458 | CBA2-C23.2 | CBA | SRC2-001 | — | CBA VII §5(b)(1), pp. 228–29 | Tight paraphrase: Unlikely Incentive Compensation in a Season may not exceed 15% of Regular Salary for that Season | Supplies the independently judgeable requirement stated by CBA2-C23.2 | — | — |
| EV2-0459 | CBA2-C23.3 | CBA | SRC2-001 | — | CBA VII §5(b)(1), p. 229 | Tight paraphrase: An Extension may carry forward otherwise excess Unlikely Bonuses only within the exact pre-existing-bonus proviso | Supplies the independently judgeable requirement stated by CBA2-C23.3 | — | — |
| EV2-0460 | CBA2-C23.4 | CBA | SRC2-001 | — | CBA VII §5(b)(1), p. 229 | Tight paraphrase: A Renegotiation may not increase Unlikely Bonuses when the result would exceed 15% of Regular Salary | Supplies the independently judgeable requirement stated by CBA2-C23.4 | — | — |
| EV2-0461 | CBA2-C23.5 | CBA | SRC2-001 | — | CBA II §12(a)(ii), p. 59 | Tight paraphrase: A signing bonus may not exceed 15% of total Compensation excluding Incentive Compensation | Supplies the independently judgeable requirement stated by CBA2-C23.5 | — | — |
| EV2-0462 | CBA2-C23.6 | CBA | SRC2-001 | — | CBA II §12(a)(ii), p. 59 | Tight paraphrase: A signing bonus in an Offer Sheet may not exceed 10% of total Compensation excluding Incentive Compensation | Supplies the independently judgeable requirement stated by CBA2-C23.6 | — | — |
| EV2-0463 | CBA2-C23.7 | CBA | SRC2-001 | — | CBA VII §3(a)(1), p. 198; XXV §1, pp. 431–32 | Tight paraphrase: Deferred Compensation is included in Salary for the Season earned, not the Season paid | Supplies the independently judgeable requirement stated by CBA2-C23.7 | — | — |
| EV2-0464 | CBA2-C23.8 | CBA | SRC2-001 | — | CBA XXV §1, pp. 431–32 | Tight paraphrase: Deferred Compensation generally may not exceed 25% of the Compensation earned for that Season | Supplies the independently judgeable requirement stated by CBA2-C23.8 | — | — |
| EV2-0465 | CBA2-C23.9 | CBA | SRC2-001 | — | CBA VII §3(e)(1), pp. 208–09 | The table sets $825,000 for 2023-24 through $975,000 for 2029-30 in $25,000 steps | Supplies the complete Excluded International Player Payment Amount table | — | — |
| EV2-0466 | CBA2-C23.10 | CBA | SRC2-001 | — | CBA VII §3(e)(3), p. 209 | The Excluded International Player Payment Amount may not be used more than once in any three-Salary-Cap-Year period for the same player | Supplies the use-frequency rule | — | — |
| EV2-0467 | CBA2-C23.11 | CBA | SRC2-001 | — | CBA VII §3(e)(1), pp. 208–09 | Any international-player payment above the scheduled excluded amount is Salary in the form of a signing bonus | Supplies the excess-payment treatment | — | — |
| EV2-0468 | CBA2-C23.12 | CBA | SRC2-001 | — | CBA VII §3(e)(7), p. 210 | International-player payments may not induce Two-Way or Exhibit 10 Contracts and create a one-year bar | Supplies the path prohibition and consequence | — | — |
| EV2-0469 | CBA2-C23.13 | CBA | SRC2-001 | — | CBA VII §3(c)(1), p. 205 | Imputed interest uses Prime plus one point, bounded between seven and nine percent, less actual interest | Supplies the complete imputed-interest rule | — | — |
| EV2-0470 | CBA2-C23.14 | CBA | SRC2-001 | — | CBA VII §3(c)(2), pp. 205–06 | Aggregate Team loans may not exceed current-year Salary protected for lack of skill | Supplies the loan ceiling | — | — |
| EV2-0471 | CBA2-C23.15 | CBA | SRC2-001 | — | CBA VII §3(g), p. 210 | Tight paraphrase: Reimbursement of qualifying disability-insurance premiums is excluded from Salary only under the signed policy and payment conditions | Supplies the independently judgeable requirement stated by CBA2-C23.15 | — | — |
| EV2-0472 | CBA2-C23.16 | INFERRED | SRC2-001 | EV2-0457, EV2-0458, EV2-0459, EV2-0460 | CBA II §12(a)(i), p. 59; VII §5(b)(1), pp. 228–29 | Tight paraphrase: Incentive compliance requires the total and unlikely ceilings plus the Extension and Renegotiation provisos | Supplies the independently judgeable requirement stated by CBA2-C23.16 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0473 | CBA2-C23.17 | INFERRED | SRC2-001 | EV2-0461, EV2-0462, EV2-0463, EV2-0464, EV2-0465, EV2-0466, EV2-0467, EV2-0468, EV2-0469, EV2-0470, EV2-0471, EV2-0518, EV2-0519, EV2-0520, EV2-0521, EV2-0522, EV2-0523, EV2-0524, EV2-0525, EV2-0526, EV2-0529 | CBA II §12(a)(ii), p. 59; VII §3, pp. 198–210; XXV §1, pp. 431–32 | Separate terms govern signing bonus, deferral, international-player payment, loan, and premium treatment | Supplies staged special-compensation compliance | Inference over the listed direct components | Direct component owners control |
| EV2-0474 | CBA2-C24.1 | CBA | SRC2-001 | — | CBA XII §§1(a), 2(a), pp. 336–37 | Tight paraphrase: A Team or Player Option may cover exactly one Season | Supplies the independently judgeable requirement stated by CBA2-C24.1 | — | — |
| EV2-0475 | CBA2-C24.2 | CBA | SRC2-001 | — | CBA XII §§1(a), 2(a), pp. 336–37 | Tight paraphrase: A Contract may contain no more than one Team Option and no more than one Player Option | Supplies the independently judgeable requirement stated by CBA2-C24.2 | — | — |
| EV2-0476 | CBA2-C24.3 | CBA | SRC2-001 | — | CBA XII §§1(a), 2(a), pp. 336–37 | Tight paraphrase: A Team or Player Option may not be conditional | Supplies the independently judgeable requirement stated by CBA2-C24.3 | — | — |
| EV2-0477 | CBA2-C24.4 | CBA | SRC2-001 | — | CBA XII §§1(a), 2(a), pp. 336–37 | Tight paraphrase: An Option Season may not reduce Salary, Likely Bonuses, or Unlikely Bonuses from the preceding Season | Supplies the independently judgeable requirement stated by CBA2-C24.4 | — | — |
| EV2-0478 | CBA2-C24.5 | CBA | SRC2-001 | — | CBA XII §§1(a), 2(a), pp. 336–37 | Tight paraphrase: An Option Season otherwise carries the preceding Season’s terms and protection | Supplies the independently judgeable requirement stated by CBA2-C24.5 | — | — |
| EV2-0479 | CBA2-C24.6 | CBA | SRC2-001 | — | CBA XII §1(a)(v), p. 336; VII §6(h), pp. 239–40 | Tight paraphrase: A Second Round Pick Exception Team Option may use the separate compensation schedule permitted by that exception | Supplies the independently judgeable requirement stated by CBA2-C24.6 | — | — |
| EV2-0480 | CBA2-C24.7 | CBA | SRC2-001 | — | CBA XII §2(a), p. 337 | Tight paraphrase: A Player Option must select one of the signed pre-exercise protection structures, including protection attaching only after the last game | Supplies the independently judgeable requirement stated by CBA2-C24.7 | — | — |
| EV2-0481 | CBA2-C24.8 | CBA | SRC2-001 | — | CBA XII §4(a), pp. 338–39 | Tight paraphrase: The ordinary Option and ETO deadline is June 29 at 5 p.m. Eastern unless the Contract validly states an earlier date | Supplies the independently judgeable requirement stated by CBA2-C24.8 | — | — |
| EV2-0482 | CBA2-C24.9 | CBA | SRC2-001 | — | CBA XII §4(b), p. 339 | Tight paraphrase: An Option whose decline would make the player a Restricted Free Agent must be exercised before June 25 | Supplies the independently judgeable requirement stated by CBA2-C24.9 | — | — |
| EV2-0483 | CBA2-C24.10 | CBA | SRC2-001 | — | CBA XII §3(a), p. 338 | Tight paraphrase: An Early Termination Option may not become effective before the end of the fourth Contract Season | Supplies the independently judgeable requirement stated by CBA2-C24.10 | — | — |
| EV2-0484 | CBA2-C24.11 | CBA | SRC2-001 | — | CBA XII §3(a), p. 338 | Tight paraphrase: A Contract may contain no more than one Early Termination Option | Supplies the independently judgeable requirement stated by CBA2-C24.11 | — | — |
| EV2-0485 | CBA2-C24.12 | CBA | SRC2-001 | — | CBA XII §3(a), p. 338 | Tight paraphrase: An Early Termination Option may not be conditional | Supplies the independently judgeable requirement stated by CBA2-C24.12 | — | — |
| EV2-0486 | CBA2-C24.13 | CBA | SRC2-001 | — | CBA VII §7(a)(1), pp. 250–51; XII §3, p. 338 | Tight paraphrase: Exercise of an ETO bars a later Veteran Extension, and an applicable Veteran Extension must eliminate the existing ETO | Supplies the independently judgeable requirement stated by CBA2-C24.13 | — | — |
| EV2-0487 | CBA2-C24.14 | CBA | SRC2-001 | — | CBA VII §7(a)(1), p. 249; XII §3, p. 338 | Tight paraphrase: A Rookie Scale Extension may add an ETO effective at the end of the fourth extended Season under the signed conditions | Supplies the independently judgeable requirement stated by CBA2-C24.14 | — | — |
| EV2-0488 | CBA2-C24.15 | CBA | SRC2-001 | — | CBA XII §4, pp. 338–40 | Tight paraphrase: Exercise or non-exercise of an Option or ETO requires the written notices specified by the CBA | Supplies the independently judgeable requirement stated by CBA2-C24.15 | — | — |
| EV2-0489 | CBA2-C24.16 | INFERRED | SRC2-001 | EV2-0474, EV2-0475, EV2-0476, EV2-0477, EV2-0478, EV2-0479, EV2-0480, EV2-0481, EV2-0482, EV2-0488 | CBA XII §§1–2, 4, pp. 336–40 | Tight paraphrase: Option compliance requires one-Season shape, count, unconditionality, compensation, unchanged terms, protection, carveout, and deadlines | Supplies the independently judgeable requirement stated by CBA2-C24.16 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0490 | CBA2-C24.17 | INFERRED | SRC2-001 | EV2-0481, EV2-0483, EV2-0484, EV2-0485, EV2-0486, EV2-0487, EV2-0488 | CBA XII §§3–4, pp. 338–40; VII §7(a), pp. 249–51 | Tight paraphrase: ETO compliance requires the fourth-Season floor, count, unconditionality, deadline, notice, and extension interactions | Supplies the independently judgeable requirement stated by CBA2-C24.17 | Inference over the cited primary text and listed direct components | Direct component owners control |
| EV2-0491 | CBA2-C25.1 | CBA | SRC2-001 | — | CBA VII §4(a)(2)(ii), p. 212 | Tight paraphrase: Team Salary includes amounts paid or payable under the Player Contract of a retired player | Supplies the independently judgeable requirement stated by CBA2-C25.1 | — | — |
| EV2-0492 | CBA2-C25.2 | CBA | SRC2-001 | — | CBA VII §4(a)(2)(ii), pp. 212–13 | Tight paraphrase: On retirement, unearned protected Compensation is attributed among remaining Salary Cap Years under the signed rule | Supplies the independently judgeable requirement stated by CBA2-C25.2 | — | — |
| EV2-0493 | CBA2-C25.3 | CBA | SRC2-001 | — | CBA VII §4(a)(6); XIII §5, pp. 214, 356–57 | Tight paraphrase: Team Salary includes consideration or value imputed because an arrangement is found to circumvent the CBA | Supplies the independently judgeable requirement stated by CBA2-C25.3 | — | External determination is an input; legal treatment remains CBA-controlled |
| EV2-0494 | CBA2-C25.4 | CBA | SRC2-001 | — | CBA VII §4(a)(7), pp. 214–15 | Tight paraphrase: Team Salary includes anticipated Salary under a reported pending Contract or amendment, subject to physical and assignment conditions | Supplies the independently judgeable requirement stated by CBA2-C25.4 | — | — |
| EV2-0495 | CBA2-C25.5 | CBA | SRC2-001 | — | CBA VII §4(a)(7), p. 215 | Tight paraphrase: Only the pending amount above the otherwise applicable Free Agent Amount is added | Supplies the independently judgeable requirement stated by CBA2-C25.5 | — | — |
| EV2-0496 | CBA2-C25.6 | CBA | SRC2-001 | — | CBA VII §4(a)(8), p. 215 | Tight paraphrase: Fifty percent of disputed current or future grievance Salary is included while the grievance is pending | Supplies the independently judgeable requirement stated by CBA2-C25.6 | — | — |
| EV2-0497 | CBA2-C25.7 | CBA | SRC2-001 | — | CBA VII §4(a)(8), pp. 215–16 | Tight paraphrase: A grievance resolved in its related Salary Cap Year is reconciled to the resolution amount in that year | Supplies the independently judgeable requirement stated by CBA2-C25.7 | — | — |
| EV2-0498 | CBA2-C25.8 | CBA | SRC2-001 | — | CBA VII §4(a)(8), p. 216 | Tight paraphrase: A grievance resolved later is adjusted under the signed later-year Team Salary and tax reconciliation rules | Supplies the independently judgeable requirement stated by CBA2-C25.8 | — | — |
| EV2-0499 | CBA2-C25.9 | CBA | SRC2-001 | — | CBA VII §4(a)(8), p. 216 | Tight paraphrase: A multi-Season grievance award is attributed pro rata unless the arbitrator specifies another allocation | Supplies the independently judgeable requirement stated by CBA2-C25.9 | — | External determination is an input; legal treatment remains CBA-controlled |
| EV2-0500 | CBA2-C25.10 | CBA | SRC2-001 | — | CBA VII §4(a)(9), p. 216 | Tight paraphrase: Teams must promptly disclose grievance resolutions and related payments to the NBA and Players Association | Supplies the independently judgeable requirement stated by CBA2-C25.10 | — | — |
| EV2-0501 | CBA2-C25.11 | CBA | SRC2-001 | — | CBA VII §4(a)(9); XIII §5, pp. 216, 356–57 | Tight paraphrase: A delayed grievance resolution may be recharacterized when the delay is found to be circumvention | Supplies the independently judgeable requirement stated by CBA2-C25.11 | — | External determination is an input; legal treatment remains CBA-controlled |

| EV2-0502 | CBA2-C19.20 | INFERRED | SRC2-001 | EV2-0387 | CBA II §10, p. 50; IX §1, p. 295 | Tight paraphrase: A Rest-of-Season Contract may also cover future Seasons subject to the applicable Article IX maximum term because Article II §10 supplies no shorter express term | Supplies the independently judgeable requirement stated by CBA2-C19.20 | Inference over the cited primary text and listed component | Direct component owner controls |
| EV2-0503 | CBA2-C20.29 | CBA | SRC2-001 | — | CBA II §11(a)(v), pp. 51–52 | Tight paraphrase: A Two-Way Advance requires partial lack-of-skill and injury-or-illness protection at signing, payment before November 1, and a limit of 50% of the signing-time protected Base Compensation | Supplies the independently judgeable requirement stated by CBA2-C20.29 | — | — |
| EV2-0504 | CBA2-C20.30 | CBA | SRC2-001 | — | CBA II §11(a)(v), pp. 51–52 | Tight paraphrase: A Two-Way Advance must be deducted first from the November 1 Base Compensation installment and then from later installments as necessary | Supplies the independently judgeable requirement stated by CBA2-C20.30 | — | — |
| EV2-0505 | CBA2-C20.31 | CBA | SRC2-001 | — | CBA II §11(c)(i), p. 53 | Tight paraphrase: Two-Way protection may conditionally increase to 50% of Base Compensation if the Team does not request waivers by the negotiated date on or after the first Regular Season day | Supplies the independently judgeable requirement stated by CBA2-C20.31 | — | — |
| EV2-0506 | CBA2-C21.25 | CBA | SRC2-001 | — | CBA II §3(r), pp. 20–21 | Tight paraphrase: An Exhibit 9 Contract must cover exactly one Season | Supplies the independently judgeable requirement stated by CBA2-C21.25 | — | — |
| EV2-0507 | CBA2-C21.26 | CBA | SRC2-001 | — | CBA II §3(r), pp. 20–21 | Tight paraphrase: An Exhibit 9 Contract must provide the applicable Minimum Player Salary or Two-Way Player Salary | Supplies the independently judgeable requirement stated by CBA2-C21.26 | — | — |
| EV2-0508 | CBA2-C21.27 | CBA | SRC2-001 | — | CBA II §3(r), pp. 20–21 | Tight paraphrase: An Exhibit 9 Contract may not include a bonus | Supplies the independently judgeable requirement stated by CBA2-C21.27 | — | — |
| EV2-0509 | CBA2-C21.28 | CBA | SRC2-001 | — | CBA II §3(r), pp. 20–21 | Tight paraphrase: An Exhibit 9 Contract may not include Compensation Protection other than its governed injury termination protection | Supplies the independently judgeable requirement stated by CBA2-C21.28 | — | — |
| EV2-0510 | CBA2-C21.29 | CBA | SRC2-001 | — | CBA II §3(s), pp. 21–22 | Tight paraphrase: Exhibit 10 bonus eligibility generally requires the player to be waived before the first Regular Season day | Supplies the independently judgeable requirement stated by CBA2-C21.29 | — | — |
| EV2-0511 | CBA2-C21.30 | CBA | SRC2-001 | — | CBA II §3(s), pp. 21–22 | Tight paraphrase: The waiving Team must designate the player for its NBA G League affiliate under the signed Exhibit 10 process | Supplies the independently judgeable requirement stated by CBA2-C21.30 | — | — |
| EV2-0512 | CBA2-C21.31 | CBA | SRC2-001 | — | CBA II §3(s), pp. 21–22 | Tight paraphrase: The designated player must timely report to the NBA G League affiliate to begin qualifying Exhibit 10 service | Supplies the independently judgeable requirement stated by CBA2-C21.31 | — | — |
| EV2-0513 | CBA2-C21.32 | CBA | SRC2-001 | — | CBA II §11(h), pp. 56–58 | Tight paraphrase: Exhibit 10 conversion rescinds the player’s Exhibit 10 bonus right | Supplies the independently judgeable requirement stated by CBA2-C21.32 | — | — |
| EV2-0514 | CBA2-C21.33 | CBA | SRC2-001 | — | CBA II §11(h), pp. 56–58 | Tight paraphrase: Exhibit 10 conversion creates Base Compensation protection for lack of skill and injury or illness at the Conversion Protection Amount | Supplies the independently judgeable requirement stated by CBA2-C21.33 | — | — |
| EV2-0515 | CBA2-C22.12 | CBA | SRC2-001 | — | CBA VII §5(a)(1), p. 227 | Tight paraphrase: The ordinary annual Salary and bonus increase or decrease limit is five percent of first-year Regular Salary | Supplies the independently judgeable requirement stated by CBA2-C22.12 | — | — |
| EV2-0516 | CBA2-C22.13 | CBA | SRC2-001 | — | CBA VII §5(a)(2), pp. 227–28 | Tight paraphrase: The signed Prior-Team and Extension routes may use an eight-percent annual increase or decrease limit | Supplies the independently judgeable requirement stated by CBA2-C22.13 | — | — |
| EV2-0517 | CBA2-C22.14 | CBA | SRC2-001 | — | CBA VII §5(a), pp. 227–28 | Tight paraphrase: Annual-change limits are measured from first-year Regular Salary rather than compounded from each preceding Season | Supplies the independently judgeable requirement stated by CBA2-C22.14 | — | — |
| EV2-0518 | CBA2-C23.18 | CBA | SRC2-001 | — | CBA VII §3(e)(2), p. 209 | Tight paraphrase: A qualifying international-player release payment up to the year’s Excluded International Player Payment Amount is not Salary | Supplies the independently judgeable requirement stated by CBA2-C23.18 | — | — |
| EV2-0519 | CBA2-C23.19 | CBA | SRC2-001 | — | CBA VII §3(e)(3), p. 209 | Tight paraphrase: A governed international-player payment may be paid in one or multiple installments | Supplies the independently judgeable requirement stated by CBA2-C23.19 | — | — |
| EV2-0520 | CBA2-C23.20 | CBA | SRC2-001 | — | CBA VII §3(e)(4), p. 209 | Tight paraphrase: Excluded International Player Payment Amount use occurs on the Contract date regardless of payment date, and a signing-time installment schedule is not multiple use | Supplies the independently judgeable requirement stated by CBA2-C23.20 | — | — |
| EV2-0521 | CBA2-C23.21 | CBA | SRC2-001 | — | CBA VII §3(e)(5), p. 210 | Tight paraphrase: No payment governed by the international-player rule counts toward Minimum Team Salary | Supplies the independently judgeable requirement stated by CBA2-C23.21 | — | — |
| EV2-0522 | CBA2-C23.22 | CBA | SRC2-001 | — | CBA VII §3(e)(6), p. 210 | Tight paraphrase: The NBA must notify the Players Association in writing within two business days after receiving notice of a governed international-player payment | Supplies the independently judgeable requirement stated by CBA2-C23.22 | — | — |
| EV2-0523 | CBA2-C23.23 | CBA | SRC2-001 | — | CBA VII §3(c)(2), p. 206 | A mid-Season loan maximum is reduced when remaining fully protected Current Base Compensation is below the maximum annual allocable repayment amount | Supplies the loan-timing reduction | — | — |
| EV2-0524 | CBA2-C23.24 | CBA | SRC2-001 | — | CBA VII §3(c)(2), p. 206 | Tight paraphrase: A Team loan must be repaid in equal annual amounts through deductions from remaining fully protected Current Base Compensation before any ETO Season | Supplies the independently judgeable requirement stated by CBA2-C23.24 | — | — |
| EV2-0525 | CBA2-C23.25 | CBA | SRC2-001 | — | CBA VII §3(c)(3), p. 206 | Tight paraphrase: A Team may not make a player loan that violates Article II §13(e) or when the Contract’s Base Compensation equals the Minimum Player Salary | Supplies the independently judgeable requirement stated by CBA2-C23.25 | — | — |
| EV2-0526 | CBA2-C23.26 | CBA | SRC2-001 | — | CBA VII §3(c)(4), p. 206 | Tight paraphrase: Team forgiveness of a player loan is deemed a Renegotiation in the Salary Cap Year of forgiveness | Supplies the independently judgeable requirement stated by CBA2-C23.26 | — | — |
| EV2-0527 | CBA2-C25.12 | INFERRED | SRC2-001 | EV2-0491, EV2-0492, EV2-0493 | CBA VII §4(a)(2)(ii), (6), pp. 212–14; XIII §5, pp. 356–57 | Tight paraphrase: Retired-player and circumvention Team Salary compliance requires Contract amounts, retirement allocation, and any adjudicated imputed value to be applied independently | Supplies the independently judgeable requirement stated by CBA2-C25.12 | Inference over the cited primary text and listed components | Direct component owners control |
| EV2-0528 | CBA2-C25.13 | INFERRED | SRC2-001 | EV2-0496, EV2-0497, EV2-0498, EV2-0499, EV2-0500, EV2-0501 | CBA VII §4(a)(8)–(9), pp. 215–16; XIII §5, pp. 356–57 | Tight paraphrase: Grievance Team Salary compliance requires pending inclusion, same- or later-year reconciliation, multi-Season allocation, disclosure, and circumvention treatment | Supplies the independently judgeable requirement stated by CBA2-C25.13 | Inference over the cited primary text and listed components | Direct component owners control |
| EV2-0529 | CBA2-C23.27 | CBA | SRC2-001 | — | CBA VII §3(c)(1), p. 205 | Prime Rate is the prime rate reported in The Wall Street Journal’s Money Rates column or its successor | Supplies the player-loan rate-source definition | — | — |
