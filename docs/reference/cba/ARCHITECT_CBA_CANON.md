...
and is pending independent checker review. R3 remains rejected, no A-series
record is accepted, and R3.1 remains blocked pending that compatibility
checker ACCEPT. Phase 1 remains open; Phase 2 and W1.1 remain blocked.
...
it changes no active record and does not start R3.1. Only an independent
compatibility checker ACCEPT can unblock R3.1.
...
the current goal objective authority, and the pre-R3.1 compatibility maker
checkpoint remains pending independent review. Neither accepts an active
A-series record. "Mechanical"
