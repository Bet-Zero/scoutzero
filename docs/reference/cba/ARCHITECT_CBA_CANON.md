...
**Current R2.14 status (supersedes the R2.13 sequencing sentence above):**
...
immutable rejected historical evidence and unblock nothing. R2.14 closes
exactly those ID-normalization and truthful-status defects. R3 remains
rejected, no A-series record is accepted, and R3.1 remains blocked pending an
independent R2.14 checker ACCEPT. Phase 1 remains open; Phase 2 and W1.1
remain blocked.
...
### 15.9 Register and source-certification standard (v2.0 — binding, R2.1 edition as hardened by R2.2 and corrected by R2.3–R2.14)
...
It unifies record-ID cell normalization and corrects every live route while
changing no active §15.10–§15.12 record-table row. R2.14 accepts no active
record and does not start R3.1; only an independent R2.14 checker ACCEPT can
unblock it.
...
independent R2.14 checker ACCEPT → R3.1 → independent R3.1
checker ACCEPT → R4 →
independent R4 checker ACCEPT → R5 → independent R5 checker ACCEPT →
R6**. R4 depends on an independently **accepted** R2.14 foundation and
...
R2.11–R2.13 are immutable rejected history; R2.14 is a maker checkpoint
pending independent review and accepts nothing. "Mechanical"
