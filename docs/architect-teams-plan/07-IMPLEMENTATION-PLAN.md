...
- Normalize draft-pick inputs to the **structured pick schema** (status, Stepien, isSwap/swapDetails, dependsOn, conveyanceObligation, conditions, route/via, metadata). De-duplicate repeated entries (e.g., repeated `OKC_2026_1st`).
