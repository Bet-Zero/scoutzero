...
```jsonc
{
  ...
  "capHolds": [
    ...
    {
      "playerId": "empty_roster_charge_1",
      "playerName": "Empty Roster Charge",
      "amount": 1119563,  // League minimum
      "type": "Empty Roster",
      "isSigned": false
    }
  ],
  ...
  "draftPicks": [
    {
      ...
      "owned": true,
      "isOwn": true,
      "protections": "Top-4 protected",
      "notes": "Sent to NOP if 1-4, else NOP receives 2027 1st",
      "conditionalOn": "LAL_2027_1st"
    },
    {
      "year": 2026,
      "round": 2,
