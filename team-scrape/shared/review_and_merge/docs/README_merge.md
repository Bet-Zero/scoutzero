...
**Salary Data:**
- Primary: `team-scrape/team-data/output/team.json` (latest team scraped)
- Per-team: `team-scrape/team-data/output/team_{CODE}.json` (individual teams)

**Draft Pick Data:**
- Pattern: `team-scrape/draft-picks/output/structured/draft_picks_{CODE}.json`
...
2. Input files exist? Check `team-scrape/team-data/output/` and `team-scrape/draft-picks/output/structured/`
...
# Output automatically goes to team-scrape/team-data/output/team_MEM.json
```
