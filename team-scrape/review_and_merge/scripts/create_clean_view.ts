 ...
 * Usage:
 *   npm run clean-view
 *   tsx team-scrape/review_and_merge/scripts/create_clean_view.ts
 */
...
// Main execution
async function main() {
  const inputDir = path.join(process.cwd(), 'team-scrape/review_and_merge/out_merged_samples');
  const outputDir = path.join(process.cwd(), 'team-scrape/review_and_merge/out_clean_views');
