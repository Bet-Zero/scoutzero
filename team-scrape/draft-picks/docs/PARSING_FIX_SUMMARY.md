...
Running `npx tsx team-scrape/draft-picks/scripts/validate_pick_parsing.ts` on current data:
...
npx tsx team-scrape/draft-picks/scripts/validate_pick_parsing.ts
```
...
cat team-scrape/draft-picks/output/by_current_owner/draft_picks_OKC.json | \
...
1. **team-scrape/draft-picks/scripts/realgm_draft_picks.ts**
...
4. **team-scrape/draft-picks/scripts/validate_pick_parsing.ts** (new)
