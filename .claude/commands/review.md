...
**Scope:** $ARGUMENTS
**Primary Goal:** Perform an open-ended cleanup and quality audit of the scoped area and return an evidence-backed package of anything wrong, risky, inconsistent, confusing, unnecessary, incomplete, brittle, or worth improving.
...
# $ARGUMENTS — PREFLIGHT RETURN PACKAGE
